...
WHERE
	CASE
		WHEN r."Value1" = r."Value2" THEN True
		ELSE False
	END = CASE
...
WHERE
	CASE
		WHEN r."Value1" = r."Value5" AND r."Value5" IS NOT NULL THEN True
		ELSE False
	END = CASE
		WHEN r."Value4" = r."Value2" AND r."Value4" IS NOT NULL THEN True
		ELSE False
	END
...
WHERE
	CASE
		...
		ELSE False
	END = CASE
		WHEN r."Value2" = r."Value1" THEN True
		ELSE False
	END
