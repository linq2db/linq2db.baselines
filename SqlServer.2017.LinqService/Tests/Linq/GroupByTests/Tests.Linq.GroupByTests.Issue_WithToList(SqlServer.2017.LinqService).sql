...
SET     @Id = '7ce3639e-db51-4dbb-93fd-1281b3d9675f'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = NULL
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 19, 19, 40, 3408202, 0, 0, 7)
...
-- SqlServer.2017
DECLARE @Id UniqueIdentifier -- Guid
SET     @Id = 'd227ac18-6379-421e-ae04-abd839d2d69d'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = '7ce3639e-db51-4dbb-93fd-1281b3d9675f'
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 19, 19, 40, 3408202, 0, 0, 7)
...
SET     @key = '7ce3639e-db51-4dbb-93fd-1281b3d9675f'
