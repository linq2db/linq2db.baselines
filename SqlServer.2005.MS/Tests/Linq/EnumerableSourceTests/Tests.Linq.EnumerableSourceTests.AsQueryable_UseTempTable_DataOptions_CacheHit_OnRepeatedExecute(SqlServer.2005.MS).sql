...
CREATE TABLE [tempdb]..[#T_493274f81bfc]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_493274f81bfc]
(
	[Id],
	[Data]
)
...
SELECT
	...
	[t1].[Data]
FROM
	[tempdb]..[#T_493274f81bfc] [t1]
ORDER BY
	[t1].[Id]

-- SqlServer.2005.MS SqlServer.2005

IF (OBJECT_ID(N'[tempdb]..[#T_493274f81bfc]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_493274f81bfc]
