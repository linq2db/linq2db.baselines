...
CREATE TABLE [tempdb]..[#T_78909685d1a9]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_78909685d1a9]
(
	[Id],
	[Data]
)
...
SELECT
	...
	[t1].[Data]
FROM
	[tempdb]..[#T_78909685d1a9] [t1]
ORDER BY
	[t1].[Id]

-- SqlServer.2005.MS SqlServer.2005

IF (OBJECT_ID(N'[tempdb]..[#T_78909685d1a9]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_78909685d1a9]
