...
CREATE TABLE [tempdb]..[#T_d6129b10807b]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_d6129b10807b]
(
	[Id],
	[Data]
)
...
SELECT
	...
	[t1].[Data]
FROM
	[tempdb]..[#T_d6129b10807b] [t1]
ORDER BY
	[t1].[Id]

-- SqlServer.2005.MS SqlServer.2005

IF (OBJECT_ID(N'[tempdb]..[#T_d6129b10807b]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_d6129b10807b]
