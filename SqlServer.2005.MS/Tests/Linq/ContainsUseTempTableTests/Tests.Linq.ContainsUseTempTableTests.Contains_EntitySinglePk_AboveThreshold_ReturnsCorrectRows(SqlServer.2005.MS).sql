...
CREATE TABLE [tempdb]..[#T_f6fbcf930449]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_f6fbcf930449]
(
	[Id],
	[Name],
	[Tag]
...
IF (OBJECT_ID(N'[tempdb]..[#T_f6fbcf930449]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_f6fbcf930449]
