...
CREATE TABLE [tempdb]..[#T_6ad670d08b2f]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_6ad670d08b2f]
(
	[Id],
	[Name],
	[Tag]
...
IF (OBJECT_ID(N'[tempdb]..[#T_6ad670d08b2f]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_6ad670d08b2f]
