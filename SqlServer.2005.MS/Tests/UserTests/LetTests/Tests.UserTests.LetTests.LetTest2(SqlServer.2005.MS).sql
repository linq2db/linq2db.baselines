...
IF (OBJECT_ID(N'[Table7]', N'U') IS NOT NULL)
	DROP TABLE [Table7]
...
FROM
	[Table2] [t1]
		...
		ON ([a_Ref5].[Field4] = [a_Ref5_1].[Field4] OR [a_Ref5].[Field4] IS NULL AND [a_Ref5_1].[Field4] IS NULL) AND ([a_Ref5].[Field8] = [a_Ref5_1].[Field8] OR [a_Ref5].[Field8] IS NULL AND [a_Ref5_1].[Field8] IS NULL) AND [a_Ref1].[Field3] = [t2].[Field3]
