...
CREATE TABLE [tempdb]..[#T_a3e3fba8c272]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_a3e3fba8c272]
(
	[Id],
	[Data]
)
...
SELECT
	...
	[t1].[Data]
FROM
	[tempdb]..[#T_a3e3fba8c272] [t1]
ORDER BY
	[t1].[Id]

-- SqlServer.2005

IF (OBJECT_ID(N'[tempdb]..[#T_a3e3fba8c272]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_a3e3fba8c272]
