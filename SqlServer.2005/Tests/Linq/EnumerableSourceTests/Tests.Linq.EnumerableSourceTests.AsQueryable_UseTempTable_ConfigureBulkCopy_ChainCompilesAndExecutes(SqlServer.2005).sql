...
CREATE TABLE [tempdb]..[#T_b1b72fd02793]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_b1b72fd02793]
(
	[Id],
	[Data]
)
...
SELECT
	...
	[t1].[Data]
FROM
	[tempdb]..[#T_b1b72fd02793] [t1]
ORDER BY
	[t1].[Id]

-- SqlServer.2005

IF (OBJECT_ID(N'[tempdb]..[#T_b1b72fd02793]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_b1b72fd02793]
