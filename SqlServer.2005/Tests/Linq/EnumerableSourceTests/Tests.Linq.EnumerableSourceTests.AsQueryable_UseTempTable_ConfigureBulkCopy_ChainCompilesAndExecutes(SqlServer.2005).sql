...
CREATE TABLE [tempdb]..[#T_343b10b09753]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_343b10b09753]
(
	[Id],
	[Data]
)
...
SELECT
	...
	[t1].[Data]
FROM
	[tempdb]..[#T_343b10b09753] [t1]
ORDER BY
	[t1].[Id]

-- SqlServer.2005

IF (OBJECT_ID(N'[tempdb]..[#T_343b10b09753]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_343b10b09753]
