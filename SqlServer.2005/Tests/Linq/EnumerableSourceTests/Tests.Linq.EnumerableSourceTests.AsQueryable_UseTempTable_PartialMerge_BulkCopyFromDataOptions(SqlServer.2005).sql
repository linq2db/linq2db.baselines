...
CREATE TABLE [tempdb]..[#T_30ee1f487f2e]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_30ee1f487f2e]
(
	[Id],
	[Data]
)
...
SELECT
	...
	[t1].[Data]
FROM
	[tempdb]..[#T_30ee1f487f2e] [t1]
ORDER BY
	[t1].[Id]

-- SqlServer.2005

IF (OBJECT_ID(N'[tempdb]..[#T_30ee1f487f2e]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_30ee1f487f2e]
