...
CREATE TABLE [tempdb]..[#T_0a2f7a7cc4b3]
(
	[Id]   Int            NOT NULL,
...
INSERT INTO [tempdb]..[#T_0a2f7a7cc4b3]
(
	[Id],
	[Data]
)
...
SELECT
	...
	[t1].[Data]
FROM
	[tempdb]..[#T_0a2f7a7cc4b3] [t1]
ORDER BY
	[t1].[Id]

-- SqlServer.2005

IF (OBJECT_ID(N'[tempdb]..[#T_0a2f7a7cc4b3]', N'U') IS NOT NULL)
	DROP TABLE [tempdb]..[#T_0a2f7a7cc4b3]
