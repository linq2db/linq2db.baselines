...
IF (OBJECT_ID(N'[Issue2933Car]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[Issue2933Person]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[Issue2933Pet]', N'U') IS NOT NULL)
...
SELECT N'Snuffles',1,1 UNION ALL
SELECT N'Buddy',2,1
