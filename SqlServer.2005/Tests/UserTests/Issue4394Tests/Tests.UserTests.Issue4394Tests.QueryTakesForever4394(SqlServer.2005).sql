...
SELECT
	...
	CASE
		WHEN [a1].[Id] IS NOT NULL AND [a1].[Id] <> '00000000-0000-0000-0000-000000000000'
			THEN 1
		ELSE 0
	END,
	[a1].[Id],
...
SELECT
	...
	END,
	CASE
		WHEN [a2].[Id] IS NOT NULL AND [a2].[Id] <> '00000000-0000-0000-0000-000000000000'
			THEN 1
		ELSE 0
	END,
	[a2].[Id],
	...
	END,
	CASE
		WHEN [a3].[Id] IS NOT NULL AND [a3].[Id] <> '00000000-0000-0000-0000-000000000000'
			THEN 1
		ELSE 0
	END,
	[a3].[Id],
	...
	END,
	CASE
		WHEN [a4].[Id] IS NOT NULL AND [a4].[Id] <> '00000000-0000-0000-0000-000000000000'
			THEN 1
		ELSE 0
	END,
	[a4].[Id],
	...
	END,
	CASE
		WHEN [a5].[Id] IS NOT NULL AND [a5].[Id] <> '00000000-0000-0000-0000-000000000000'
			THEN 1
		ELSE 0
	END,
	[a5].[Id],
	...
	END,
	CASE
		WHEN [a6].[Id] IS NOT NULL AND [a6].[Id] <> '00000000-0000-0000-0000-000000000000'
			THEN 1
		ELSE 0
	END,
	[a6].[Id],
	...
	END,
	CASE
		WHEN [a7].[Id] IS NOT NULL AND [a7].[Id] <> '00000000-0000-0000-0000-000000000000'
			THEN 1
		ELSE 0
	END,
	[a7].[Id],
	...
	END,
	CASE
		WHEN [a8].[Id] IS NOT NULL AND [a8].[Id] <> '00000000-0000-0000-0000-000000000000'
			THEN 1
		ELSE 0
	END,
	[a8].[Id],
