...
HAVING
	...
	MAX(IIF([g_1].[ChildID] >= 19 AND [g_1].[ChildID] IS NOT NULL, [g_1].[ParentID], NULL)) IS NOT NULL AND
	MAX(IIF([g_1].[ChildID] >= 18 AND [g_1].[ChildID] IS NOT NULL, [g_1].[ParentID], NULL)) > 0 AND
	MAX(IIF([g_1].[ChildID] >= 18 AND [g_1].[ChildID] IS NOT NULL, [g_1].[ParentID], NULL)) IS NOT NULL
