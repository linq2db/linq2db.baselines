...
SET     @Id = '4611ad1e-5056-4b8b-bada-a1b5979c6943'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = NULL
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 18, 59, 15, 4142963, 0, 0, 7)
...
-- SqlServer.Contained SqlServer.2019
DECLARE @Id UniqueIdentifier -- Guid
SET     @Id = 'fb433612-c5e7-4fcd-a6fe-a52f83f8efdc'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = '4611ad1e-5056-4b8b-bada-a1b5979c6943'
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 18, 59, 15, 4142963, 0, 0, 7)
...
SET     @key = '4611ad1e-5056-4b8b-bada-a1b5979c6943'
