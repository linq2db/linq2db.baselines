...
WHERE
	([a_Parent].[ParentID] <> [t2].[ParentID] OR [a_Parent].[Value1] <> [t2].[Value1] OR [a_Parent].[Value1] IS NULL AND [t2].[Value1] IS NOT NULL OR [a_Parent].[Value1] IS NOT NULL AND [t2].[Value1] IS NULL OR [a_Parent].[ParentID] IS NULL AND [t2].[ParentID] IS NOT NULL OR [a_Parent].[ParentID] IS NOT NULL AND [t2].[ParentID] IS NULL) AND
	([x].[ParentID] <> (
		SELECT TOP (1)
