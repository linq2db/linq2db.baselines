...
IF (OBJECT_ID(N'[Issue2815Table1]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[Issue2815Table2]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[Issue2815Table3]', N'U') IS NOT NULL)
