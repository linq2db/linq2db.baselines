...
SELECT
	...
	COUNT(ALL p.ParentID) OVER(PARTITION BY p.Value1 ORDER BY p.Value1 ROWS BETWEEN UNBOUNDED PRECEDING AND toInt32(3) PRECEDING),
	...
	COUNT(ALL p.ParentID) OVER(PARTITION BY p.Value1 ORDER BY p.Value1 ROWS toInt32(1) PRECEDING),
	...
	COUNT(p.ParentID) OVER(PARTITION BY p.Value1 ORDER BY p.Value1 ROWS BETWEEN UNBOUNDED PRECEDING AND toInt32(3) PRECEDING),
	...
	COUNT(p.ParentID) OVER(PARTITION BY p.Value1 ORDER BY p.Value1 ROWS toInt32(1) PRECEDING),
