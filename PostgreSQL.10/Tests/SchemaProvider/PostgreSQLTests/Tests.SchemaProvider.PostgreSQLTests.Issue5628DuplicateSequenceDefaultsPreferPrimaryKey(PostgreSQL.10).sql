...
-- PostgreSQL.10 PostgreSQL.9.5 PostgreSQL
CREATE TABLE issue5628_two_defaults_pk_97 (
	...
	CONSTRAINT issue5628_two_defaults_pk_97_pkey PRIMARY KEY (item_id)
)
...
RollbackTransaction
-- PostgreSQL.10 PostgreSQL.9.5 PostgreSQL
DROP TABLE IF EXISTS issue5628_two_defaults_pk_97
