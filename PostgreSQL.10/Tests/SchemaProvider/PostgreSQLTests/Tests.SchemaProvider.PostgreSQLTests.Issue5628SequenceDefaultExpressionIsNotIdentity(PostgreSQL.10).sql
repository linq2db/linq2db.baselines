...
CREATE SEQUENCE issue5628_code_seq_108

-- PostgreSQL.10 PostgreSQL.9.5 PostgreSQL
CREATE SEQUENCE issue5628_item_id_seq_108

-- PostgreSQL.10 PostgreSQL.9.5 PostgreSQL
CREATE TABLE issue5628_sample_messages_108 (
	code character varying(255) DEFAULT ('PREFIX_'::text || nextval('issue5628_code_seq_108'::regclass)) NOT NULL,
	...
	CONSTRAINT issue5628_sample_messages_108_pkey PRIMARY KEY (item_id, item_type),
	CONSTRAINT issue5628_sample_messages_108_code_key UNIQUE (code)
)
...
RollbackTransaction
-- PostgreSQL.10 PostgreSQL.9.5 PostgreSQL
DROP TABLE IF EXISTS issue5628_sample_messages_108

-- PostgreSQL.10 PostgreSQL.9.5 PostgreSQL
DROP SEQUENCE IF EXISTS issue5628_code_seq_108
