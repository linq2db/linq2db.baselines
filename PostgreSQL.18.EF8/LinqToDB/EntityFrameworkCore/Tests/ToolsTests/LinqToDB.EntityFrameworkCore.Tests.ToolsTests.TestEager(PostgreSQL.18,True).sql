...
LEFT JOIN (
    ...
    INNER JOIN (
        ...
        WHERE @__ef_filter__p_0 OR NOT (t2."IsDeleted") OR NOT (t2."IsDeleted")
    ) AS t0 ON e0."TerritoryID" = t0."TerritoryID"
    WHERE @__ef_filter__p_0 OR NOT (e0."IsDeleted") OR NOT (e0."IsDeleted")
...
LEFT JOIN (
    ...
    WHERE @__ef_filter__p_0 OR NOT (o0."IsDeleted") OR NOT (o0."IsDeleted")
