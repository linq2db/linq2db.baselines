...
USING (
	SELECT
		...
		t1."Field2" as "source_Delete1",
		t1."Field3" as "source_Field",
		t1."Field4" as "source_field1",
...
SET
	...
	"Field2" = "Source"."source_Delete1",
	"Field3" = "Source"."source_Field",
	"Field4" = "Source"."source_field1",
	"Field5" = "Source"."source_As"
WHERE
	"Source"."source_field1" = 214 AND "Source"."source_field1" IS NOT NULL OR
"Source"."source_order" = 3
DELETE WHERE
	Target."Id" = 3
