...
INSERT INTO l2dbnh_authors (name, id) VALUES (:p0, :p1);:p0 = 'Asimov' [Type: String (0:0:0)], :p1 = 31 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_authors (name, id) VALUES (:p0, :p1);:p0 = 'Clarke' [Type: String (0:0:0)], :p1 = 32 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_books (title, id) VALUES (:p0, :p1);:p0 = 'Foundation' [Type: String (0:0:0)], :p1 = 33 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_books (title, id) VALUES (:p0, :p1);:p0 = 'I, Robot' [Type: String (0:0:0)], :p1 = 34 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_books (title, id) VALUES (:p0, :p1);:p0 = '2001' [Type: String (0:0:0)], :p1 = 35 [Type: Int32 (0:0:0)]
