Parameters:
@__ef_filter__p_0='?', @__ef_filter__p_1='?'
...
CROSS JOIN (
    ...
    FROM "Products" AS "p0"
    WHERE (@__ef_filter__p_0 OR NOT ("p0"."IsDeleted")) AND ((
        SELECT COUNT(*)
        FROM "Order Details" AS "o"
        WHERE (@__ef_filter__p_1 OR NOT ("o"."IsDeleted")) AND ("p0"."ProductID" = "o"."ProductID")) > 0)
) AS "t"
WHERE ((@__ef_filter__p_0 OR NOT ("p"."IsDeleted")) AND ((
    SELECT COUNT(*)
    FROM "Order Details" AS "o0"
    WHERE (@__ef_filter__p_1 OR NOT ("o0"."IsDeleted")) AND ("p"."ProductID" = "o0"."ProductID")) > 0)) AND ("p"."ProductID" = "t"."ProductID")
