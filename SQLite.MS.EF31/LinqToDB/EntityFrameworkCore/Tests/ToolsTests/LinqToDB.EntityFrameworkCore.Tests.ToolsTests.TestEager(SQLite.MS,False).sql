Parameters:
@__ef_filter__p_1='?', @__ef_filter__p_4='?', @__ef_filter__p_2='?', @__ef_filter__p_5='?', @__ef_filter__p_3='?', @__ef_filter__p_0='?'
...
LEFT JOIN (
    ...
    INNER JOIN (
        ...
        WHERE @__ef_filter__p_4 OR NOT ("t0"."IsDeleted")
...
LEFT JOIN (
    ...
    INNER JOIN (
        ...
        FROM "Products" AS "p"
        WHERE @__ef_filter__p_5 OR NOT ("p"."IsDeleted")
