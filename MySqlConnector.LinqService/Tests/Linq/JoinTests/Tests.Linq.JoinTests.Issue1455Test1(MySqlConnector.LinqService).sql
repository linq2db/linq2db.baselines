			...
			(
				...
				LEFT JOIN (
					SELECT
						...
						Cast(`trade_1`.`DealId` as CHAR(255)) as `c1`
					FROM
						`Trade` `trade_1`
				...
				LEFT JOIN (
					SELECT
						...
						Cast(`nomin_1`.`CargoId` as CHAR(255)) as `c1`
					FROM
						`Nomin` `nomin_1`
				...
				(
					...
					LEFT JOIN (
						SELECT
							...
							`trade_3`.`DealId`,
							`trade_3`.`ParcelId`,
							Cast(`trade_3`.`DealId` as CHAR(255)) as `c1`
						FROM
							`Trade` `trade_3`
					...
					LEFT JOIN (
						SELECT
							...
							`nomin_3`.`CargoId`,
							`nomin_3`.`DeliveryId`,
							Cast(`nomin_3`.`CargoId` as CHAR(255)) as `c1`
						FROM
							`Nomin` `nomin_3`
