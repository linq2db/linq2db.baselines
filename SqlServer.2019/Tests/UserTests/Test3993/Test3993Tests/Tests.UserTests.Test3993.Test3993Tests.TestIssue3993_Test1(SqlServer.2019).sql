...
FROM
	[Common_Topology_Locations] [x]
WHERE
	DateAdd(millisecond, @Value, DateAdd(hour, @Value_1, [x].[StartDateTime2])) > DATETIME2FROMPARTS(2025, 8, 31, 17, 35, 3, 1303426, 7)
...
FROM
	[Common_Topology_Locations] [x]
WHERE
	DateAdd(millisecond, @Value, DateAdd(hour, @Value_1, [x].[StartDateTime2])) > DATETIME2FROMPARTS(2025, 8, 31, 17, 35, 3, 1403412, 7)
