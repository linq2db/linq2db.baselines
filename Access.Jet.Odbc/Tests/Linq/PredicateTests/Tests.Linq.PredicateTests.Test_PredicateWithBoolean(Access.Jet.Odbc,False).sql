...
FROM
	[BooleanTable] [r]
WHERE
	(([r].[Value5] = [r].[Value4] OR [r].[Value5] IS NULL AND [r].[Value4] IS NULL) AND NOT ([r].[Value5] IS NULL AND [r].[Value4] IS NOT NULL) AND NOT ([r].[Value5] IS NOT NULL AND [r].[Value4] IS NULL)) = (?)
