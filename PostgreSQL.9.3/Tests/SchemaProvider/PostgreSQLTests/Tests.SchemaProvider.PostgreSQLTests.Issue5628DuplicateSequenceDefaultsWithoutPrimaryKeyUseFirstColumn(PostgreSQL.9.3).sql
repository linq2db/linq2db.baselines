...
-- PostgreSQL.9.3 PostgreSQL
CREATE TABLE issue5628_two_defaults_no_pk_94 (
	code integer DEFAULT nextval('issue5628_code_seq_94'::regclass) NOT NULL,
...
RollbackTransaction
-- PostgreSQL.9.3 PostgreSQL
DROP TABLE IF EXISTS issue5628_two_defaults_no_pk_94
