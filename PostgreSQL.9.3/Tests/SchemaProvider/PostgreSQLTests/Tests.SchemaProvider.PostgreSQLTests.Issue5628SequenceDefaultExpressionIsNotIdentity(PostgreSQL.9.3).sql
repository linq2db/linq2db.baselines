...
-- PostgreSQL.9.3 PostgreSQL
CREATE TABLE issue5628_sample_messages_96 (
	code character varying(255) DEFAULT ('PREFIX_'::text || nextval('issue5628_code_seq_96'::regclass)) NOT NULL,
	...
	CONSTRAINT issue5628_sample_messages_96_pkey PRIMARY KEY (item_id, item_type),
	CONSTRAINT issue5628_sample_messages_96_code_key UNIQUE (code)
)
...
RollbackTransaction
-- PostgreSQL.9.3 PostgreSQL
DROP TABLE IF EXISTS issue5628_sample_messages_96
