...
-- PostgreSQL.9.3 PostgreSQL
CREATE TABLE issue5628_parenthesized_default_94 (
...
FROM pg_attrdef
WHERE adrelid = 'issue5628_parenthesized_default_94'::regclass
AND adnum = 1
...
RollbackTransaction
-- PostgreSQL.9.3 PostgreSQL
DROP TABLE IF EXISTS issue5628_parenthesized_default_94
