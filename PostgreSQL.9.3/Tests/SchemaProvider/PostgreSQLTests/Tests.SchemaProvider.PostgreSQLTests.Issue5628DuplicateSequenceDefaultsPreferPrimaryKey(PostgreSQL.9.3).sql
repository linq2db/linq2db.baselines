...
-- PostgreSQL.9.3 PostgreSQL
CREATE TABLE issue5628_two_defaults_pk_92 (
	...
	CONSTRAINT issue5628_two_defaults_pk_92_pkey PRIMARY KEY (item_id)
)
...
RollbackTransaction
-- PostgreSQL.9.3 PostgreSQL
DROP TABLE IF EXISTS issue5628_two_defaults_pk_92
