...
CREATE SEQUENCE issue5628_code_seq_95

-- PostgreSQL.9.3 PostgreSQL
CREATE SEQUENCE issue5628_item_id_seq_95

-- PostgreSQL.9.3 PostgreSQL
CREATE TABLE issue5628_two_defaults_pk_95 (
	code integer DEFAULT nextval('issue5628_code_seq_95'::regclass) NOT NULL,
	item_id integer DEFAULT nextval('issue5628_item_id_seq_95'::regclass) NOT NULL,
	CONSTRAINT issue5628_two_defaults_pk_95_pkey PRIMARY KEY (item_id)
)
...
RollbackTransaction
-- PostgreSQL.9.3 PostgreSQL
DROP TABLE IF EXISTS issue5628_two_defaults_pk_95

-- PostgreSQL.9.3 PostgreSQL
DROP SEQUENCE IF EXISTS issue5628_code_seq_95

-- PostgreSQL.9.3 PostgreSQL
DROP SEQUENCE IF EXISTS issue5628_item_id_seq_95
