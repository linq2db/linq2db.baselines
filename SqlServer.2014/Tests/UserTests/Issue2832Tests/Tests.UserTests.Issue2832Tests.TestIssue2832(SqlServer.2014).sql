...
FROM
	[DctSetpointtype] [spt]
		...
		ON [d].[SetpointtypeId] = [spt].[Id] AND UTILS.GREATESTNOTNULL3(CAST([cudg].[Permission] AS Decimal(38, 17)), CAST([oudg].[Inheritablepermission] AS Decimal(38, 17)), NULL) IS NOT NULL
