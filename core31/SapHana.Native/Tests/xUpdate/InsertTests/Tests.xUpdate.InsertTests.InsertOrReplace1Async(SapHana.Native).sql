...
WHERE
	"Patient"."PersonID" = :"PersonID_1_1_1_1"
...
DECLARE @Diagnosis NVarChar(4) -- String
SET     @Diagnosis = 'abc1'
DECLARE @PersonID_1_1_1_1_1  -- Int32
SET     @PersonID_1_1_1_1_1 = 5
...
SET
	"Patient"."Diagnosis" = :"Diagnosis"
WHERE
	"Patient"."PersonID" = :"PersonID_1_1_1_1_1"

BeforeExecute
-- SapHana.Native SapHana (asynchronously)
DECLARE @Diagnosis NVarChar(4) -- String
SET     @Diagnosis = 'abc2'
DECLARE @PersonID_1_1_1_1_1_1  -- Int32
SET     @PersonID_1_1_1_1_1_1 = 5
...
SET
	"Patient"."Diagnosis" = :"Diagnosis"
WHERE
	"Patient"."PersonID" = :"PersonID_1_1_1_1_1_1"
