...
DECLARE @ncharDataType NChar -- StringFixedLength
SET     @ncharDataType = 'ü'
...
DECLARE @varbinaryDataType Binary(3)
SET     @varbinaryDataType = x'010203'
DECLARE @blobDataType Binary(6)
