...
SELECT year2DataType FROM `AllTypes` WHERE ID = 1
...
SELECT year2DataType FROM `AllTypes` WHERE ID = 2
...
SELECT ID FROM `AllTypes` WHERE year2DataType = @p
...
SELECT year4DataType FROM `AllTypes` WHERE ID = 1
...
SELECT year4DataType FROM `AllTypes` WHERE ID = 2
...
SELECT ID FROM `AllTypes` WHERE year4DataType = @p
