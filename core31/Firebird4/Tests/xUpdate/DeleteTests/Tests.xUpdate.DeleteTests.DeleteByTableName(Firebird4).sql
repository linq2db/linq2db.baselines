...
EXECUTE BLOCK AS BEGIN
	IF (NOT EXISTS(SELECT 1 FROM rdb$relations WHERE rdb$relation_name = 'xxPerson_f4_1a')) THEN
		EXECUTE STATEMENT '
		...
		';
	IF (NOT EXISTS(SELECT 1 FROM rdb$generators WHERE rdb$generator_name = 'GIDENTITY_xxPerson_f4_1a')) THEN
		EXECUTE STATEMENT '
			CREATE GENERATOR "GIDENTITY_xxPerson_f4_1a"
		';
	IF (NOT EXISTS(SELECT 1 FROM rdb$triggers WHERE rdb$trigger_name = 'TIDENTITY_xxPerson_f4_1a')) THEN
		EXECUTE STATEMENT '
