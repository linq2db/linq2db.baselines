...
IF (OBJECT_ID(N'[AccessTariff]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[CountryState]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[AutonomousCommunity]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[InvoicePendingState]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[TypeBMeasures]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[Town]', N'U') IS NOT NULL)
	DROP TABLE [Town]
...
IF (OBJECT_ID(N'[InvoiceLine]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[AccountTax]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[InvoiceTaxLine]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[MeasureSource]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[TypeAMeasures]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[StreetType]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[ServicePoint]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[ProductUnit]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[CustomInvoice]', N'U') IS NOT NULL)
...
IF (OBJECT_ID(N'[CustomInvoiceLine]', N'U') IS NOT NULL)
