...
FROM
	(
		...
		OUTER APPLY (
			...
			WHERE
				([nomin_4].[DeliveryCounterParty] LIKE @DeliveryCounterParty OR [trade_4].[CounterParty] LIKE @DeliveryCounterParty OR [t2].[AlertCode] LIKE @DeliveryCounterParty) AND
