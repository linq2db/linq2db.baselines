...
SELECT
	...
	[bind_1].[ShipVia],
	[bind_1].[Freight],
	IIF([bind_1].[OrderID] IS NOT NULL AND [a_Shipper].[ShipperID] IS NOT NULL, 1, 0),
	[a_Shipper].[ShipperID],
	[a_Shipper].[CompanyName],
	[a_Shipper].[Phone],
	IIF([bind_1].[OrderID] IS NOT NULL AND [a_Employee].[EmployeeID] IS NOT NULL, 1, 0),
	...
	[bind].[PhotoPath],
	[bind_3].[EmployeeID],
	IIF([bind_3].[EmployeeID] IS NOT NULL AND [a_Employee_1].[EmployeeID] IS NOT NULL, 1, 0),
