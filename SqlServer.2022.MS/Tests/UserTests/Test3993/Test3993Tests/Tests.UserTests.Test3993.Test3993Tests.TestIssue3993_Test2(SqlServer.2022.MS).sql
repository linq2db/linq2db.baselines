...
WHERE
	...
	[x].[NotificationDateTime] < DATETIME2FROMPARTS(2025, 8, 31, 18, 5, 8, 2928703, 7) AND
	CAST([x].[StartDateTime] AS Date) < CAST(DATETIME2FROMPARTS(2025, 8, 31, 18, 5, 8, 2930698, 7) AS Date)
