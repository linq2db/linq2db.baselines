...
SET
	...
	"Value2" = (
		...
		FROM
			"UpdatedEntities" "t3"
				INNER JOIN "NewEntities" "t_2" ON "t_2"."id" = "t3"."id"
		WHERE
			"t_2"."id" <> @someId AND "UpdatedEntities"."id" = "t3"."id"
	),
	"Value3" = (
		SELECT
		...
		FROM
			"UpdatedEntities" "t4"
				INNER JOIN "NewEntities" "t_3" ON "t_3"."id" = "t4"."id"
		WHERE
			"t_3"."id" <> @someId AND "UpdatedEntities"."id" = "t4"."id"
	)
WHERE
	EXISTS(
		SELECT
