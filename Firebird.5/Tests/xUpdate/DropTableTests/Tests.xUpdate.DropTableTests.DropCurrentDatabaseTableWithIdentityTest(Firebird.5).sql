...
EXECUTE BLOCK AS BEGIN
	EXECUTE STATEMENT 'CREATE TABLE "DropTableTestID"
(
	ID  Int  NOT NULL,
	ID1 Int  NOT NULL,
...
';
	EXECUTE STATEMENT 'CREATE GENERATOR "GIDENTITY_DropTableTestID"';
	EXECUTE STATEMENT 'CREATE TRIGGER "TIDENTITY_DropTableTestID" FOR "DropTableTestID"
