...
SELECT 1,CAST(_utf8 x'E38080' AS VarChar(255) CHARACTER SET UNICODE_FSS) FROM rdb$database UNION ALL
SELECT 2,_utf8 x'20E3808020' FROM rdb$database UNION ALL
SELECT 3,_utf8 x'20E380807820' FROM rdb$database
