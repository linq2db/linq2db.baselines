...
SET     @p_1 = DATETIME2FROMPARTS(2023, 2, 28, 4, 36, 56, 5106798, 7)
DECLARE @p_2 DateTime2
SET     @p_2 = DATETIME2FROMPARTS(2023, 2, 28, 4, 36, 56, 9770002, 7)
DECLARE @p_3 DateTime2
SET     @p_3 = DATETIME2FROMPARTS(2023, 2, 28, 4, 36, 56, 5106798, 7)
DECLARE @p_4 DateTime2
SET     @p_4 = DATETIME2FROMPARTS(2023, 2, 28, 4, 36, 56, 9770002, 7)
