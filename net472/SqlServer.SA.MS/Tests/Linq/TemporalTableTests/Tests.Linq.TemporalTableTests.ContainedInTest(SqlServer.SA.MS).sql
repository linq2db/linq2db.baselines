...
SET     @p_1 = DATETIME2FROMPARTS(2023, 3, 1, 17, 56, 37, 6638399, 7)
DECLARE @p_2 DateTime2
SET     @p_2 = DATETIME2FROMPARTS(2023, 3, 1, 17, 56, 38, 1294652, 7)
DECLARE @p_3 DateTime2
SET     @p_3 = DATETIME2FROMPARTS(2023, 3, 1, 17, 56, 37, 6638399, 7)
DECLARE @p_4 DateTime2
SET     @p_4 = DATETIME2FROMPARTS(2023, 3, 1, 17, 56, 38, 1294652, 7)
