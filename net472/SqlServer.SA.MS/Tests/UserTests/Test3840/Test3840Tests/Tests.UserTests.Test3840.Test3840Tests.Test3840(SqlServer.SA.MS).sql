...
VALUES
(DATETIME2FROMPARTS(2023, 1, 31, 21, 27, 7, 9581945, 7),CAST(20000000000 AS BIGINT),TIMEFROMPARTS(0, 33, 20, 0, 7),TIMEFROMPARTS(0, 33, 20, 0, 7),DATETIME2FROMPARTS(2023, 1, 31, 0, 0, 0, 0, 7))
