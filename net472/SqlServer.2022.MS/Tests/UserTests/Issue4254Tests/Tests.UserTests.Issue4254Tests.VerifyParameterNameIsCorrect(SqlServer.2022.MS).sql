...
SET     @userId = '2c55805e-a375-4145-b525-90064518288d'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 17, 31, 20, 3887228, 7)
...
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 17, 31, 20, 3887228, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 17, 31, 20, 3887228, 7)
...
-- SqlServer.2022.MS SqlServer.2022
DECLARE @userId UniqueIdentifier -- Guid
SET     @userId = '514f777f-aff5-407a-bed5-c75f9d78d076'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 17, 31, 20, 5605995, 7)
...
SET     @userId = '514f777f-aff5-407a-bed5-c75f9d78d076'
DECLARE @now_1 DateTime2
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 17, 31, 20, 5605995, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 17, 31, 20, 5605995, 7)
