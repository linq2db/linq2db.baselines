...
SET     @userId = '8ef5a718-e45a-4528-9d39-16243fe9aa40'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 17, 17, 34, 1094802, 7)
...
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 17, 17, 34, 1094802, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 17, 17, 34, 1094802, 7)
...
-- SqlServer.2019.MS SqlServer.2019
DECLARE @userId UniqueIdentifier -- Guid
SET     @userId = '6a6255a7-9205-48c1-9017-e56e2298965a'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 17, 17, 34, 3283369, 7)
...
SET     @userId = '6a6255a7-9205-48c1-9017-e56e2298965a'
DECLARE @now_1 DateTime2
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 17, 17, 34, 3283369, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 17, 17, 34, 3283369, 7)
