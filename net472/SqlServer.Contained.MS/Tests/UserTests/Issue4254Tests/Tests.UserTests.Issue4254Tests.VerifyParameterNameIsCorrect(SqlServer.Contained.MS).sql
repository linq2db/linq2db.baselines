...
SET     @userId = '213e85ba-8310-47fe-85e5-35bfce6ef8c2'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 21, 20, 52, 1662881, 7)
...
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 21, 20, 52, 1662881, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 21, 20, 52, 1662881, 7)
...
-- SqlServer.Contained.MS SqlServer.2019
DECLARE @userId UniqueIdentifier -- Guid
SET     @userId = 'a685bbd0-fe39-4e97-a80c-d909bef1cc3a'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 21, 20, 52, 2288231, 7)
...
SET     @userId = 'a685bbd0-fe39-4e97-a80c-d909bef1cc3a'
DECLARE @now_1 DateTime2
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 21, 20, 52, 2288231, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 21, 20, 52, 2288231, 7)
