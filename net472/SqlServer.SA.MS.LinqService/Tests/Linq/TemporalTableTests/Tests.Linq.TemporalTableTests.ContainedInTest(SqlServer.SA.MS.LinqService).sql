...
SET     @p_1 = DATETIME2FROMPARTS(2023, 2, 28, 4, 42, 17, 5838756, 7)
DECLARE @p_2 DateTime2
SET     @p_2 = DATETIME2FROMPARTS(2023, 2, 28, 4, 42, 18, 495089, 7)
DECLARE @p_3 DateTime2
SET     @p_3 = DATETIME2FROMPARTS(2023, 2, 28, 4, 42, 17, 5838756, 7)
DECLARE @p_4 DateTime2
SET     @p_4 = DATETIME2FROMPARTS(2023, 2, 28, 4, 42, 18, 495089, 7)
