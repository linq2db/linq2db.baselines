...
SET     @cpty_5 = '%C%'
DECLARE @cpty_6 NVarChar(3) -- String
SET     @cpty_6 = '%C%'
DECLARE @cpty_7 NVarChar(3) -- String
SET     @cpty_7 = '%C%'
DECLARE @cpty_8 NVarChar(3) -- String
SET     @cpty_8 = '%C%'
DECLARE @cpty_9 NVarChar(3) -- String
SET     @cpty_9 = '%C%'
DECLARE @cpty_10 NVarChar(3) -- String
SET     @cpty_10 = '%C%'
DECLARE @cpty_11 NVarChar(3) -- String
SET     @cpty_11 = '%C%'
DECLARE @cpty_12 NVarChar(3) -- String
SET     @cpty_12 = '%C%'
DECLARE @cpty_13 NVarChar(3) -- String
SET     @cpty_13 = '%C%'
DECLARE @cpty_14 NVarChar(3) -- String
SET     @cpty_14 = '%C%'
DECLARE @cpty_15 NVarChar(3) -- String
SET     @cpty_15 = '%C%'
DECLARE @cpty_16 NVarChar(3) -- String
SET     @cpty_16 = '%C%'
DECLARE @cpty_17 NVarChar(3) -- String
SET     @cpty_17 = '%C%'
DECLARE @cpty_18 NVarChar(3) -- String
SET     @cpty_18 = '%C%'
DECLARE @cpty_19 NVarChar(3) -- String
SET     @cpty_19 = '%C%'
DECLARE @cpty_20 NVarChar(3) -- String
SET     @cpty_20 = '%C%'
DECLARE @cpty_21 NVarChar(3) -- String
SET     @cpty_21 = '%C%'
DECLARE @cpty_22 NVarChar(3) -- String
SET     @cpty_22 = '%C%'
DECLARE @cpty_23 NVarChar(3) -- String
SET     @cpty_23 = '%C%'
DECLARE @cpty_24 NVarChar(3) -- String
SET     @cpty_24 = '%C%'
DECLARE @cpty_25 NVarChar(3) -- String
SET     @cpty_25 = '%C%'
DECLARE @cpty_26 NVarChar(3) -- String
SET     @cpty_26 = '%C%'
...
SELECT
	...
	(
		...
		WHERE
			([nomin_4].[DeliveryCounterParty] LIKE @cpty ESCAPE '~' OR [trade_4].[CounterParty] LIKE @cpty_1 ESCAPE '~' OR [t1].[AlertCode] LIKE @cpty_2 ESCAPE '~') AND
	...
	(
		...
		WHERE
			([nomin_6].[DeliveryCounterParty] LIKE @cpty_3 ESCAPE '~' OR [trade_6].[CounterParty] LIKE @cpty_4 ESCAPE '~' OR [t2].[AlertCode] LIKE @cpty_5 ESCAPE '~') AND
	...
	(
		...
		WHERE
			([nomin_8].[DeliveryCounterParty] LIKE @cpty_6 ESCAPE '~' OR [trade_8].[CounterParty] LIKE @cpty_7 ESCAPE '~' OR [t3].[AlertCode] LIKE @cpty_8 ESCAPE '~') AND
	...
	(
		...
		WHERE
			([nomin_10].[DeliveryCounterParty] LIKE @cpty_9 ESCAPE '~' OR [trade_10].[CounterParty] LIKE @cpty_10 ESCAPE '~' OR [t4].[AlertCode] LIKE @cpty_11 ESCAPE '~') AND
	...
	(
		...
		WHERE
			([nomin_12].[DeliveryCounterParty] LIKE @cpty_12 ESCAPE '~' OR [trade_12].[CounterParty] LIKE @cpty_13 ESCAPE '~' OR [t5].[AlertCode] LIKE @cpty_14 ESCAPE '~') AND
	...
	(
		...
		WHERE
			([nomin_14].[DeliveryCounterParty] LIKE @cpty_15 ESCAPE '~' OR [trade_14].[CounterParty] LIKE @cpty_16 ESCAPE '~' OR [t6].[AlertCode] LIKE @cpty_17 ESCAPE '~') AND
	...
	(
		...
		WHERE
			([nomin_16].[DeliveryCounterParty] LIKE @cpty_18 ESCAPE '~' OR [trade_16].[CounterParty] LIKE @cpty_19 ESCAPE '~' OR [t7].[AlertCode] LIKE @cpty_20 ESCAPE '~') AND
	...
	(
		...
		WHERE
			([nomin_18].[DeliveryCounterParty] LIKE @cpty_21 ESCAPE '~' OR [trade_18].[CounterParty] LIKE @cpty_22 ESCAPE '~' OR [t8].[AlertCode] LIKE @cpty_23 ESCAPE '~') AND
...
WHERE
	([nomin_2].[DeliveryCounterParty] LIKE @cpty_24 ESCAPE '~' OR [trade_2].[CounterParty] LIKE @cpty_25 ESCAPE '~' OR [al_group_1].[AlertCode] LIKE @cpty_26 ESCAPE '~')
GROUP BY
	[al_group_1].[AlertKey],
	[al_group_1].[AlertCode],
