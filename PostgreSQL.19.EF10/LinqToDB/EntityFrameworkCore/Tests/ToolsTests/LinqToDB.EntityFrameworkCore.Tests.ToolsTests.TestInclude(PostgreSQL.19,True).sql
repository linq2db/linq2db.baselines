...
LEFT JOIN (
    ...
    FROM "Employees" AS e
    WHERE @ef_filter__p3 OR NOT (e."IsDeleted") OR NOT (e."IsDeleted")
...
LEFT JOIN (
    ...
    INNER JOIN (
        ...
        WHERE @ef_filter__p9 OR NOT (t."IsDeleted") OR NOT (t."IsDeleted")
    ) AS t0 ON e1."TerritoryID" = t0."TerritoryID"
    WHERE @ef_filter__p5 OR NOT (e1."IsDeleted") OR NOT (e1."IsDeleted")
...
WHERE
	NOT ("a_Territory"."IsDeleted" OR d."IsDeleted")
...
WHERE
	NOT ("a_Product"."IsDeleted" OR d."IsDeleted")
