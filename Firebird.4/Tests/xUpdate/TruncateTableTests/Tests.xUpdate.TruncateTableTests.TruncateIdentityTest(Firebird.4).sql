...
EXECUTE BLOCK AS BEGIN
	EXECUTE STATEMENT 'CREATE TABLE "TestIdTrun"
(
	ID       Int              NOT NULL,
...
';
	EXECUTE STATEMENT 'CREATE GENERATOR "GIDENTITY_TestIdTrun"';
	EXECUTE STATEMENT 'CREATE TRIGGER "TIDENTITY_TestIdTrun" FOR "TestIdTrun"
