...
SELECT 1,CAST(_utf8 x'E2819F' AS VarChar(255) CHARACTER SET UNICODE_FSS) FROM rdb$database UNION ALL
SELECT 2,_utf8 x'20E2819F20' FROM rdb$database UNION ALL
SELECT 3,_utf8 x'20E2819F7820' FROM rdb$database
