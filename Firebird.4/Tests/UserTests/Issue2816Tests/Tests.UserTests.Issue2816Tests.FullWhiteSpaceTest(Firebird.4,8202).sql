...
SELECT 1,CAST(_utf8 x'E2808A' AS VarChar(255) CHARACTER SET UNICODE_FSS) FROM rdb$database UNION ALL
SELECT 2,_utf8 x'20E2808A20' FROM rdb$database UNION ALL
SELECT 3,_utf8 x'20E2808A7820' FROM rdb$database
