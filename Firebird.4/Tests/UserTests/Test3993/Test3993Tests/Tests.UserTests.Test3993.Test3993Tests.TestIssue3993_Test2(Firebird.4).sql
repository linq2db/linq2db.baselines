...
WHERE
	...
	"x"."NotificationDateTime" < CAST('2025-08-31 17:46:51.644' AS timestamp) AND
	CAST("x"."StartDateTime" AS Date) < CAST(CAST('2025-08-31 17:46:51.644' AS timestamp) AS Date)
