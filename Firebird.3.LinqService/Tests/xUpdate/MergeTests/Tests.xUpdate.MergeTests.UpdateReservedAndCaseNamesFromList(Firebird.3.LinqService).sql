...
USING (
	SELECT 3 AS "in_1", CAST(NULL AS Int) AS "join_1", 3 AS "outer_1", CAST(NULL AS Int) AS "inner_1", CAST(NULL AS Int) AS "with_1", CAST(NULL AS Int) AS "left_1" FROM rdb$database
	UNION ALL
