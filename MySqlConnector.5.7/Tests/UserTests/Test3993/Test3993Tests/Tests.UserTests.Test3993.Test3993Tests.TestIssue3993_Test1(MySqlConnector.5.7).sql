...
FROM
	`Common_Topology_Locations` `x`
WHERE
	Date_Add(`x`.`StartDateTime2`, Interval (@Value * 1000) Microsecond) > '2025-08-31 18:03:18.776'
...
FROM
	`Common_Topology_Locations` `x`
WHERE
	Date_Add(`x`.`StartDateTime2`, Interval (@Value * 1000) Microsecond) > '2025-08-31 18:03:18.780'
