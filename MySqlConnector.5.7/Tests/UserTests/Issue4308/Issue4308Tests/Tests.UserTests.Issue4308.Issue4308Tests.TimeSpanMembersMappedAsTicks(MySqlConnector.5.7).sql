...
SELECT
	...
	CAST(CAST(`row_1`.`PreNotification` AS SIGNED) AS DECIMAL(29, 10)) / 864000000000,
	CAST(CAST(`row_1`.`PreNotification` AS SIGNED) AS DECIMAL(29, 10)) / 36000000000,
	CAST(CAST(`row_1`.`PreNotification` AS SIGNED) AS DECIMAL(29, 10)) / 600000000,
	CAST(CAST(`row_1`.`PreNotification` AS SIGNED) AS DECIMAL(29, 10)) / 10000000,
	CAST(CAST(`row_1`.`PreNotification` AS SIGNED) AS DECIMAL(29, 10)) / 10000,
	...
	CAST(CAST(`row_1`.`PreNotification` AS SIGNED) AS DECIMAL(29, 10)) / 10,
	CAST(CAST(`row_1`.`PreNotification` AS SIGNED) AS DECIMAL(29, 10)) * 100
FROM
