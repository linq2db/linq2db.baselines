...
INSERT INTO l2dbnh_documents (title, is_deleted, tenant_id) VALUES (@p0, @p1, @p2); select last_insert_rowid();@p0 = 'x{y}z' [Type: String (0:0:0)], @p1 = 0 [Type: Int32 (0:0:0)], @p2 = 1 [Type: Int32 (0:0:0)]
