...
FROM
	[Issue4226Table] [e]
WHERE
	DatePart(month, [e].[Date]) = DatePart(month, CAST('2020-02-29T00:00:00.0000000' AS DATETIME2)) AND DatePart(month, [e].[Date]) IS NOT NULL AND DatePart(month, CAST('2020-02-29T00:00:00.0000000' AS DATETIME2)) IS NOT NULL OR
