...
IF (OBJECT_ID(N'[StackOverflowTable1]', N'U') IS NOT NULL)
	DROP TABLE [StackOverflowTable1]
...
IF (OBJECT_ID(N'[StackOverflowTable2]', N'U') IS NOT NULL)
	DROP TABLE [StackOverflowTable2]
...
IF (OBJECT_ID(N'[StackOverflowTable3]', N'U') IS NOT NULL)
	DROP TABLE [StackOverflowTable3]
...
IF (OBJECT_ID(N'[StackOverflowTable4]', N'U') IS NOT NULL)
	DROP TABLE [StackOverflowTable4]
...
IF (OBJECT_ID(N'[StackOverflowTable5]', N'U') IS NOT NULL)
	DROP TABLE [StackOverflowTable5]
