...
SELECT
	...
	[a_Book_1].[BookId],
	CASE
		WHEN [a_Book_1].[Discriminator] = N'Novel' THEN 1
		ELSE 0
	END,
	[a_Book_1].[BookName],
	[a_Book_1].[NovelScore],
	CASE
		WHEN [a_Book_1].[Discriminator] = N'Roman' THEN 1
		ELSE 0
	END,
	[a_Book_1].[RomanScore],
...
SELECT
	...
	[d_1].[BookId],
	CASE
		WHEN [d_1].[Discriminator] = N'Novel' THEN 1
		ELSE 0
	END,
	[d_1].[BookName],
	[d_1].[NovelScore],
	CASE
		WHEN [d_1].[Discriminator] = N'Roman' THEN 1
		ELSE 0
	END,
	[d_1].[RomanScore],
	[d_1].[Discriminator]
...
SELECT
	...
	[a_Book].[BookId],
	CASE
		WHEN [a_Book].[Discriminator] = N'Novel' THEN 1
		ELSE 0
	END,
	[a_Book].[BookName],
	[a_Book].[NovelScore],
	CASE
		WHEN [a_Book].[Discriminator] = N'Roman' THEN 1
		ELSE 0
	END,
	[a_Book].[RomanScore],
