...
(
	...
	WHERE
		[ncGroupMember].[NC_GROUP_BO] = (N'NCGroupBO:' + Coalesce([ncCode].[SITE], N'') + N',CATAN_AUTO') OR [ncGroupMember].[NC_GROUP_BO] = (N'NCGroupBO:' + Coalesce([ncCode].[SITE], N'') + N',CATAN_MAN') OR [ncGroupMember].[NC_GROUP_BO] = (N'NCGroupBO:' + Coalesce([ncCode].[SITE], N'') + N',CATAN_ALL')
)
SELECT
	[item_1].[NcCodeBo],
	[item_1].[NcCode],
