...
FROM
	MasterClass m_1
		INNER JOIN DetailClass d ON d.MasterId = m_1.Id1 AND d.MasterId = m_1.Id2 AND d.DetailId % toInt32(2) = toInt32(0) AND d.DetailId % toInt32(2) = toInt32(0)
WHERE
	m_1.Id1 > toInt32(5)
...
FROM
	MasterClass m_1
		INNER JOIN DetailClass detail ON detail.MasterId = m_1.Id1 AND detail.MasterId = m_1.Id2 AND detail.DetailId % toInt32(2) = toInt32(0) AND detail.DetailId % toInt32(2) = toInt32(0)
WHERE
	m_1.Id1 > toInt32(5)
