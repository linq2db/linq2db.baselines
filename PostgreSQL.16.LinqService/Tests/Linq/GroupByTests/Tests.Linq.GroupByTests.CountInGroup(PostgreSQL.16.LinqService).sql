...
SELECT
	...
	(
		...
		WHERE
			(x_1."DataValue"::decimal % 2)::decimal = 0 AND (x_1."DataValue"::decimal % 2)::decimal IS NOT NULL
	),
	(
		SELECT
			COUNT(*)
		FROM
			(
				...
				WHERE
					...
					(t_1."DataValue"::decimal % 2)::decimal IS NOT NULL
			) t2
	),
	(
		SELECT
		...
		FROM
			(
				...
				WHERE
					...
					(x_2."DataValue"::decimal % 2)::decimal IS NOT NULL
			) x_3
		WHERE
			(x_3."DataValue"::decimal % 2)::decimal = 0 AND (x_3."DataValue"::decimal % 2)::decimal IS NOT NULL
	),
	t1."COUNT_5",
	(
		SELECT
		...
		FROM
			(
				...
				WHERE
					...
					(t_2."DataValue"::decimal % 2)::decimal IS NOT NULL
			) t3
	)
FROM
	(
		SELECT
			...
			COUNT(*) as "COUNT_1",
			COUNT(CASE
				WHEN (t."DataValue"::decimal % 2)::decimal = 0 AND (t."DataValue"::decimal % 2)::decimal IS NOT NULL
					THEN 1
				ELSE NULL
			END) as "COUNT_2",
			COUNT(*) as "COUNT_3",
