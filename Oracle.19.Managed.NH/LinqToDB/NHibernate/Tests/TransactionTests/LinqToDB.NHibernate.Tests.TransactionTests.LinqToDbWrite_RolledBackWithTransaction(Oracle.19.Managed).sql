...
INSERT INTO l2dbnh_customers (companyname, contactname, contacttitle, address, city, region, postalcode, country, phone, fax, isdeleted, customerid) VALUES (:p0, :p1, :p2, :p3, :p4, :p5, :p6, :p7, :p8, :p9, :p10, :p11);:p0 = 'Original Co' [Type: String (0:0:0)], :p1 = NULL [Type: String (0:0:0)], :p2 = NULL [Type: String (0:0:0)], :p3 = NULL [Type: String (0:0:0)], :p4 = NULL [Type: String (0:0:0)], :p5 = NULL [Type: String (0:0:0)], :p6 = NULL [Type: String (0:0:0)], :p7 = NULL [Type: String (0:0:0)], :p8 = NULL [Type: String (0:0:0)], :p9 = NULL [Type: String (0:0:0)], :p10 = False [Type: Int16 (0:0:0)], :p11 = 'TXROLL' [Type: String (0:0:0)]
