...
FROM
	"Issue5265Table" t1
		...
		LEFT JOIN "Issue5265SubTable03" "a_SubTable3_1" ON "a_SubTable2_1"."Id" = "a_SubTable3_1"."FK"
		LEFT JOIN "Issue5265SubTable03" "a_SubTable3_2" ON "a_SubTable3_1"."Id" = "a_SubTable3_2"."FK"
		LEFT JOIN "Issue5265SubTable05" "a_SubTable5_1" ON "a_SubTable3_2"."Id" = "a_SubTable5_1"."FK"
		LEFT JOIN "Issue5265SubTable02" "a_SubTable2_2" ON "a_SubTable5_1"."Id" = "a_SubTable2_2"."FK"
