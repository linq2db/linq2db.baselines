...
FROM
	(
		SELECT
			...
			NULL::text as "Item1_2",
			NULL::Int as "Item2_1",
			NULL::Boolean as "Item3_1",
			NULL::Int as "Item4_1",
			NULL::text as "Item5_1"
		FROM
			"CTE_2" t4
		UNION ALL
		SELECT
		...
		SELECT
			...
			t6."v0Id" as "Item1_1",
			t6."v1Label" as "Item2",
			t6.v2field_1 as "Item3",
			NULL::Int as "Item4",
			NULL::Int as "Item5",
			NULL::text as "Item6",
			NULL::Boolean as "Item7",
			t6."v1Label" as "Item1_2",
			t6."v0Id" as "Item2_1",
			t6.v3field_2 as "Item3_1",
			t6."v0Id" as "Item4_1",
			t6."v1Label" as "Item5_1"
		FROM
			(
				SELECT
					2::Int as "Item1",
					p."Id" as "v0Id",
					p."Label" as "v1Label",
					p.field_1 as v2field_1,
					p.field_2 as v3field_2
				FROM
					"CTE_1" p
			) t6
	) t7
