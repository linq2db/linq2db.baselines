...
q','1',' ',3.40282002E+38::float4,1.7976931348623157E+308::float8,'2001-10-12 21:14:15.167'::timestamp,:value_2,E'\\x000102030004'::bytea,'ffffffff-ffff-ffff-ffff-ffffffffffff'::uuid,-99999999.9999999999::decimal(19, 10),'2123-11-23'::date,:value_3,'',0),
	(5,-123,987::bigint,NULL,'<>?/.,;''zZ":','`~!@#$%^&*()_+{}|[]\',' ',' ',-1.17549996E-38::float4,2.2250738585072014E-308::float8,'2098-10-12 21:14:15.913'::timestamp,:value_4,E'\\xFFC864321400'::bytea,'ffffffff-ffff-ffff-ffff-ffffffffffff'::uuid,-0.123::decimal(3, 3),'2010-11-23'::date,:value_5,NULL,-2147483647),
	(6,2147483647,9223372036854775807::bigint,False,'test
	  ','ЙЦУКЩывапрм
q  ','-','~',3.40282002E+38::float4,1.7976931348623157E+308::float8,'2001-10-12 21:14:15.167'::timestamp,:value_6,E'\\x000102030004'::bytea,'ffffffff-ffff-ffff-ffff-ffffffffffff'::uuid,-99999999.9999999999::decimal(19, 10),'2123-11-23'::date,:value_7,'',0)
) "Source"
(
	"Id",
	"FieldInt32",
