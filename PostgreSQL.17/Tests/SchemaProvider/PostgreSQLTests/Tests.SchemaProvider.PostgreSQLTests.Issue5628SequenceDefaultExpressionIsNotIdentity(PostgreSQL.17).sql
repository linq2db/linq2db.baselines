...
CREATE SEQUENCE issue5628_code_seq_113

-- PostgreSQL.17 PostgreSQL.15 PostgreSQL12
CREATE SEQUENCE issue5628_item_id_seq_113

-- PostgreSQL.17 PostgreSQL.15 PostgreSQL12
CREATE TABLE issue5628_sample_messages_113 (
	code character varying(255) DEFAULT ('PREFIX_'::text || nextval('issue5628_code_seq_113'::regclass)) NOT NULL,
	...
	CONSTRAINT issue5628_sample_messages_113_pkey PRIMARY KEY (item_id, item_type),
	CONSTRAINT issue5628_sample_messages_113_code_key UNIQUE (code)
)
...
RollbackTransaction
-- PostgreSQL.17 PostgreSQL.15 PostgreSQL12
DROP TABLE IF EXISTS issue5628_sample_messages_113

-- PostgreSQL.17 PostgreSQL.15 PostgreSQL12
DROP SEQUENCE IF EXISTS issue5628_code_seq_113
