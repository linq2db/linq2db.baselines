...
CREATE TABLE issue5628_two_defaults_no_pk_97 (
	code integer DEFAULT nextval('issue5628_code_seq_97'::regclass) NOT NULL,
...
DROP TABLE IF EXISTS issue5628_two_defaults_no_pk_97
