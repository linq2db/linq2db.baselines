...
FROM
	`TypeTable``2` r
WHERE
	r.Column = toDateTime('1970-01-01 00:00:01') AND r.ColumnNullable = toDateTime('2106-02-07 06:28:15') AND
...
FROM
	`TypeTable``2` r
WHERE
	r.Column = toDateTime('1970-01-01 00:45:01') AND r.ColumnNullable = toDateTime('2106-02-07 05:43:15') AND
	r.ColumnNullable IS NOT NULL
