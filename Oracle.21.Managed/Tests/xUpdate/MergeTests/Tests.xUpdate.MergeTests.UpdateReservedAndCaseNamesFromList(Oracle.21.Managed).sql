...
USING (
	SELECT 3 AS "source_in", NULL AS "source_join", 3 AS "source_outer", NULL AS "source_inner", NULL AS "source_with", NULL AS "source_left" FROM sys.dual
	UNION ALL
...
WHERE
	"Source"."source_with" = 214 AND "Source"."source_with" IS NOT NULL
