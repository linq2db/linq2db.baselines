...
CREATE TABLE issue5628_sample_messages_95 (
	code character varying(255) DEFAULT ('PREFIX_'::text || nextval('issue5628_code_seq_95'::regclass)) NOT NULL,
	...
	CONSTRAINT issue5628_sample_messages_95_pkey PRIMARY KEY (item_id, item_type),
	CONSTRAINT issue5628_sample_messages_95_code_key UNIQUE (code)
)
...
DROP TABLE IF EXISTS issue5628_sample_messages_95
