...
-- PostgreSQL.13 PostgreSQL12
CREATE TABLE issue5628_two_defaults_no_pk_125 (
	code integer DEFAULT nextval('issue5628_code_seq_125'::regclass) NOT NULL,
...
RollbackTransaction
-- PostgreSQL.13 PostgreSQL12
DROP TABLE IF EXISTS issue5628_two_defaults_no_pk_125
