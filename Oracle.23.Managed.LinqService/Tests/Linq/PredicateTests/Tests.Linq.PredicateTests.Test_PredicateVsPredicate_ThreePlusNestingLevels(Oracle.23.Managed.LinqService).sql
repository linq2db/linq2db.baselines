...
WHERE
	CASE
		...
		END = CASE
			...
			WHEN r."Value1" <> r."Value4" OR r."Value4" IS NULL THEN 0
			ELSE NULL
		END AND CASE
			WHEN r."Value1" = r."Value4" AND r."Value4" IS NOT NULL THEN 1
			WHEN r."Value1" <> r."Value4" OR r."Value4" IS NULL THEN 0
	...
	END = CASE
		...
		END = CASE
			...
			WHEN r."Value2" = r."Value4" AND r."Value4" IS NOT NULL THEN 0
			ELSE NULL
		END OR CASE
			WHEN (r."Value4" = r."Value5" OR r."Value4" IS NULL AND r."Value5" IS NULL) AND NOT (r."Value4" IS NULL AND r."Value5" IS NOT NULL) AND NOT (r."Value5" IS NULL AND r."Value4" IS NOT NULL)
				THEN 1
...
WHERE
	...
	END <> CASE
		WHEN CASE
			...
			WHEN r."Value4" <> r."Value1" OR r."Value4" IS NULL THEN 0
			ELSE NULL
		END = 0 AND CASE
			WHEN r."Value4" = r."Value1" AND r."Value4" IS NOT NULL THEN 1
			WHEN r."Value4" <> r."Value1" OR r."Value4" IS NULL THEN 0
		...
		END IS NOT NULL
			THEN 1
		WHEN r."Value4" = r."Value1" AND r."Value4" IS NOT NULL THEN 0
		ELSE NULL
	END OR
	CASE
		WHEN CASE
...
WHERE
	CASE
		...
		END <> CASE
			...
			WHEN r."Value2" <> r."Value5" OR r."Value5" IS NULL THEN 0
			ELSE NULL
		END OR CASE
			WHEN r."Value2" = r."Value5" AND r."Value5" IS NOT NULL THEN 1
			WHEN r."Value2" <> r."Value5" OR r."Value5" IS NULL THEN 0
