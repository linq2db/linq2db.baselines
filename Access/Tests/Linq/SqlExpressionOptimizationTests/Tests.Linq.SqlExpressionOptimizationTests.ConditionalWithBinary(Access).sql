...
SET     @StringValue = '1'
DECLARE @StringValueNullable VarWChar(1) -- String
...
DECLARE @StringValue VarWChar(1) -- String
SET     @StringValue = '0'
DECLARE @StringValueNullable VarWChar -- String
...
FROM
	[OptimizationData] [x]
WHERE
	IIF([x].[IntVlaue] = 1, NULL, False) = True
...
FROM
	[OptimizationData] [x_with_not]
WHERE
	(IIF([x_with_not].[IntVlaue] = 1, NULL, False) = False OR IIF([x_with_not].[IntVlaue] = 1, NULL, False) IS NULL)
...
FROM
	[OptimizationData] [swap]
WHERE
	IIF([swap].[IntVlaue] = 1, NULL, False) = True
...
FROM
	[OptimizationData] [swap_with_not]
WHERE
	(IIF([swap_with_not].[IntVlaue] = 1, NULL, False) = False OR IIF([swap_with_not].[IntVlaue] = 1, NULL, False) IS NULL)
...
FROM
	[OptimizationData] [x]
WHERE
	IIF([x].[IntVlaue] = 1, NULL, True) = True
...
FROM
	[OptimizationData] [x_with_not]
WHERE
	(IIF([x_with_not].[IntVlaue] = 1, NULL, True) = False OR IIF([x_with_not].[IntVlaue] = 1, NULL, True) IS NULL)
...
FROM
	[OptimizationData] [swap]
WHERE
	IIF([swap].[IntVlaue] = 1, NULL, True) = True
...
FROM
	[OptimizationData] [swap_with_not]
WHERE
	(IIF([swap_with_not].[IntVlaue] = 1, NULL, True) = False OR IIF([swap_with_not].[IntVlaue] = 1, NULL, True) IS NULL)
...
FROM
	[OptimizationData] [x]
WHERE
	IIF([x].[BoolValue] = True, True, False) = True
...
FROM
	[OptimizationData] [x_with_not]
WHERE
	IIF([x_with_not].[BoolValue] = True, True, False) = False
...
FROM
	[OptimizationData] [swap]
WHERE
	IIF([swap].[BoolValue] = True, True, False) = True
...
FROM
	[OptimizationData] [swap_with_not]
WHERE
	IIF([swap_with_not].[BoolValue] = True, True, False) = False
...
FROM
	[OptimizationData] [x]
WHERE
	IIF([x].[BoolValue] = True, NULL, True) = True
...
FROM
	[OptimizationData] [x_with_not]
WHERE
	(IIF([x_with_not].[BoolValue] = True, NULL, True) = False OR IIF([x_with_not].[BoolValue] = True, NULL, True) IS NULL)
...
FROM
	[OptimizationData] [swap]
WHERE
	IIF([swap].[BoolValue] = True, NULL, True) = True
...
FROM
	[OptimizationData] [swap_with_not]
WHERE
	(IIF([swap_with_not].[BoolValue] = True, NULL, True) = False OR IIF([swap_with_not].[BoolValue] = True, NULL, True) IS NULL)
