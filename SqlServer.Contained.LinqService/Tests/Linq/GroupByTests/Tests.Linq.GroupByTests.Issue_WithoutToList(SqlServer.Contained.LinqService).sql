...
SET     @Id = '3bed037b-e019-400c-8cdd-ee45b54e926c'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = NULL
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 18, 59, 15, 2112278, 0, 0, 7)
...
-- SqlServer.Contained SqlServer.2019
DECLARE @Id UniqueIdentifier -- Guid
SET     @Id = 'b7b07ecc-2b8d-4e0a-9edd-238068bee40e'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = '3bed037b-e019-400c-8cdd-ee45b54e926c'
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 18, 59, 15, 2112278, 0, 0, 7)
