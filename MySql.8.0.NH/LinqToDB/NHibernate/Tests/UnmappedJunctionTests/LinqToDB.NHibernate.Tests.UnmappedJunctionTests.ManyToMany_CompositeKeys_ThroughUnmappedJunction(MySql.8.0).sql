...
INSERT INTO l2dbnh_facility (label, siteid, facilityno) VALUES (?p0, ?p1, ?p2);?p0 = 'F1' [Type: String (2:0:0)], ?p1 = 10 [Type: Int32 (0:0:0)], ?p2 = 20 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_facility (label, siteid, facilityno) VALUES (?p0, ?p1, ?p2);?p0 = 'F2' [Type: String (2:0:0)], ?p1 = 11 [Type: Int32 (0:0:0)], ?p2 = 21 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_facility (label, siteid, facilityno) VALUES (?p0, ?p1, ?p2);?p0 = 'F3' [Type: String (2:0:0)], ?p1 = 20 [Type: Int32 (0:0:0)], ?p2 = 10 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_zone (name, zoneid, zoneno) VALUES (?p0, ?p1, ?p2);?p0 = 'Alpha' [Type: String (5:0:0)], ?p1 = 1 [Type: Int32 (0:0:0)], ?p2 = 7 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_zone (name, zoneid, zoneno) VALUES (?p0, ?p1, ?p2);?p0 = 'Beta' [Type: String (4:0:0)], ?p1 = 7 [Type: Int32 (0:0:0)], ?p2 = 1 [Type: Int32 (0:0:0)]
