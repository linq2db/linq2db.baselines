...
INSERT INTO l2dbnh_member (name, memberid) VALUES (?p0, ?p1);?p0 = 'Ada' [Type: String (3:0:0)], ?p1 = 1 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_member (name, memberid) VALUES (?p0, ?p1);?p0 = 'Bob' [Type: String (3:0:0)], ?p1 = 2 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_member (name, memberid) VALUES (?p0, ?p1);?p0 = 'Cid' [Type: String (3:0:0)], ?p1 = 3 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_club (name, clubid) VALUES (?p0, ?p1);?p0 = 'Chess' [Type: String (5:0:0)], ?p1 = 1 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_club (name, clubid) VALUES (?p0, ?p1);?p0 = 'Choir' [Type: String (5:0:0)], ?p1 = 2 [Type: Int32 (0:0:0)]
