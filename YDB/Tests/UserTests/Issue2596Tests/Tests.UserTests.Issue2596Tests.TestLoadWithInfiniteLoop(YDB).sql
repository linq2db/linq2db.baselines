...
SELECT
	m_1.Id as Id,
	d.Id as Id_1,
	d.ProductUnitId as ProductUnitId,
...
SELECT
	m_1.Id as Id,
	d.Id as Id_1,
	d.CustomInvoiceId as CustomInvoiceId
FROM
	(
		SELECT DISTINCT
			f.Id as Id
...
SELECT
	...
	d.Id as Id_1,
	d.CustomInvoiceId as CustomInvoiceId,
	d.MeasuresSourceId as MeasuresSourceId,
	d.PreviousSourceId as PreviousSourceId,
	a_Source.Id as Id_2,
...
SELECT
	f.Id as Id,
	f.ContractId as ContractId,
	f.InvoiceId as InvoiceId,
	f.ServicePointId as ServicePointId,
	f.AccessTariffId as AccessTariffId,
	f.PriceListId as PriceListId,
	a_Invoice.Id as Id_1,
	a_Invoice.PendingStateId as PendingStateId,
	a_Invoice.RectifyingInvoiceId as RectifyingInvoiceId,
	a_Invoice.RefundByInvoiceId as RefundByInvoiceId,
