...
SELECT
	...
	t.DateTime + $ts as C_DateTime,
	t.DateTimeNullable + $ts as C_DateTimeNullable,
	t.DateTime2 + $ts as C_DateTime2,
	t.DateTime2Nullable + $ts as C_DateTime2Nullable
FROM
	DateTypes t
UNION ALL
SELECT
	...
	t_1.DateTime + $ts as C_DateTime,
	t_1.DateTimeNullable + $ts as C_DateTimeNullable,
	t_1.DateTime2 + $ts as C_DateTime2,
	t_1.DateTime2Nullable + $ts as C_DateTime2Nullable
FROM
	DateTypes t_1
