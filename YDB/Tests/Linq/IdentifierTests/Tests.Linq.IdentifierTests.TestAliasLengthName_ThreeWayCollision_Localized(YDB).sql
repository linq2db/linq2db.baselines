...
SELECT
	`long親Long子Long孫LongVeryLongVeryVeryLongVeryVeryLongLongAliasNameTestParent`.ParentID as ParentID,
	`long親Long子Long孫LongVeryLongVeryVeryLongVeryVeryLongLongAliasNameTestParent`.Value1 as Value1
FROM
