...
SELECT
	...
	MAX(e.ModifiedAt) as ModifiedAt,
	MAX(CASE
...
SELECT
	r_1.Key_1 as Key_1,
	r_1.CoaName as CoaName,
	r_1.PosLibRub as PosLibRub,
	r_1.ModifiedAt as ModifiedAt,
	r_1.IDE_10 as IDE_10,
	r_1.IDE_20 as IDE_20,
	r_1.IDE_30 as IDE_30,
	r_1.LIB_10 as LIB_10,
	r_1.LIB_20 as LIB_20,
	r_1.LIB_30 as LIB_30
FROM
	(
		SELECT
			r.Id as Key_1,
...
WHERE
	r_1.Key_1 = 1 AND r_1.IDE_20 = 'IDE-B'u
