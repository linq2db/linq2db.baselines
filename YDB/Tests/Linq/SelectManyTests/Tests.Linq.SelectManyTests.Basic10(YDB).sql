...
FROM
	(
		...
		CROSS JOIN Child o
		INNER JOIN Parent a_ParentID2_1 ON o.ParentID = a_ParentID2_1.ParentID AND g_1.ParentID2 = a_ParentID2_1.ParentID
		LEFT JOIN Parent a_Parent ON o.ParentID = a_Parent.ParentID
WHERE
	g_1.Value1 = a_ParentID2_1.Value1 OR g_1.Value1 IS NULL AND a_ParentID2_1.Value1 IS NULL
