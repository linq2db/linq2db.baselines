...
SET     @Id = '5353acee-499d-4801-bafc-1609a6f35df0'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = NULL
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 19, 17, 6, 8067606, 0, 0, 7)
...
-- SqlServer.2016.MS SqlServer.2016
DECLARE @Id UniqueIdentifier -- Guid
SET     @Id = '83275975-86d3-4317-b86d-624861a09acd'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = '5353acee-499d-4801-bafc-1609a6f35df0'
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 19, 17, 6, 8067606, 0, 0, 7)
...
SET     @key = '5353acee-499d-4801-bafc-1609a6f35df0'
