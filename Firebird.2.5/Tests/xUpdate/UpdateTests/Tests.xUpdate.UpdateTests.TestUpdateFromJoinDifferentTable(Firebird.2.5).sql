...
SET
	...
	"col2" = (
		...
		FROM
			"gt_s_one" "x_2"
				...
				LEFT JOIN "access_mode" "y1_2" ON Upper(REPLACE("x_2"."col3", 'auth.', '')) = Upper("y1_2"."code") AND Upper(REPLACE("x_2"."col3", 'auth.', '')) IS NOT NULL AND Upper("y1_2"."code") IS NOT NULL OR Upper(REPLACE("x_2"."col3", 'auth.', '')) IS NULL AND Upper("y1_2"."code") IS NULL
		WHERE
	...
	"col3" = (
		...
		FROM
			"gt_s_one" "x_3"
				...
				LEFT JOIN "access_mode" "y1_3" ON Upper(REPLACE("x_3"."col3", 'auth.', '')) = Upper("y1_3"."code") AND Upper(REPLACE("x_3"."col3", 'auth.', '')) IS NOT NULL AND Upper("y1_3"."code") IS NOT NULL OR Upper(REPLACE("x_3"."col3", 'auth.', '')) IS NULL AND Upper("y1_3"."code") IS NULL
		WHERE
	...
	"col4" = (
		...
		FROM
			"gt_s_one" "x_4"
				...
				LEFT JOIN "access_mode" "y1_4" ON Upper(REPLACE("x_4"."col3", 'auth.', '')) = Upper("y1_4"."code") AND Upper(REPLACE("x_4"."col3", 'auth.', '')) IS NOT NULL AND Upper("y1_4"."code") IS NOT NULL OR Upper(REPLACE("x_4"."col3", 'auth.', '')) IS NULL AND Upper("y1_4"."code") IS NULL
		WHERE
	...
	"col5" = (
		SELECT
			CASE
				WHEN "x_5"."col3" = 'empty' AND "x_5"."col3" IS NOT NULL
					THEN '1'
				ELSE '0'
			END
		FROM
			"gt_s_one" "x_5"
				...
				LEFT JOIN "access_mode" "y1_5" ON Upper(REPLACE("x_5"."col3", 'auth.', '')) = Upper("y1_5"."code") AND Upper(REPLACE("x_5"."col3", 'auth.', '')) IS NOT NULL AND Upper("y1_5"."code") IS NOT NULL OR Upper(REPLACE("x_5"."col3", 'auth.', '')) IS NULL AND Upper("y1_5"."code") IS NULL
		WHERE
	...
	"col6" = (
		SELECT
			CASE
				WHEN "x_6"."col3" = 'empty' AND "x_6"."col3" IS NOT NULL
					THEN ''
				ELSE "y1_6"."id"
			END
		FROM
			"gt_s_one" "x_6"
				...
				LEFT JOIN "access_mode" "y1_6" ON Upper(REPLACE("x_6"."col3", 'auth.', '')) = Upper("y1_6"."code") AND Upper(REPLACE("x_6"."col3", 'auth.', '')) IS NOT NULL AND Upper("y1_6"."code") IS NOT NULL OR Upper(REPLACE("x_6"."col3", 'auth.', '')) IS NULL AND Upper("y1_6"."code") IS NULL
		WHERE
