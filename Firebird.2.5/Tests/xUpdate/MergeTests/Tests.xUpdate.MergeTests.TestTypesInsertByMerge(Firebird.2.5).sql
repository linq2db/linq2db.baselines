...
	' AS VARCHAR(9)), CAST(_utf8 x'D099D0A6D0A3D09AD0A9D18BD0B2D0B0D0BFD180D0BC0D0A71' AS VARCHAR(25)), '1', ' ', 3.40282002E+38, TIMESTAMP '2001-10-12 21:14:15.1670', X'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', -99999999.9999999999, TIMESTAMP '2123-11-23 00:00:00.0000', CAST(_utf8 x'00' AS VARCHAR(1)), 0 FROM rdb$database
	UNION ALL
	SELECT 5, -123, 987, CAST(@FieldBoolean_2 AS CHAR(1)), CAST('<>?/.,;''zZ":' AS VARCHAR(12)), CAST('`~!@#$%^&*()_+{}|[]\' AS VARCHAR(20)), ' ', ' ', -1.17549996E-38, TIMESTAMP '2098-10-12 21:14:15.9130', X'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', -0.123, TIMESTAMP '2010-11-23 00:00:00.0000', NULL, -2147483647 FROM rdb$database
	UNION ALL
