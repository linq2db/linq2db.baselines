	...
	(
		...
		FROM
			"LinqDataTypes" "x"
				...
				INNER JOIN "LinqDataTypes" "r" ON ("u"."IntValue" = "r"."IntValue" AND "u"."IntValue" IS NOT NULL AND "r"."IntValue" IS NOT NULL OR "u"."IntValue" IS NULL AND "r"."IntValue" IS NULL) AND ("u"."IntValue" = "r"."IntValue" AND "u"."IntValue" IS NOT NULL AND "r"."IntValue" IS NOT NULL OR "u"."IntValue" IS NULL AND "r"."IntValue" IS NULL) AND '0' = "r"."BoolValue" AND "r"."BoolValue" IS NOT NULL
