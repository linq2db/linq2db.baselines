	...
	(
		...
		FROM
			"LinqDataTypes" "x"
				...
				INNER JOIN "LinqDataTypes" "r" ON ("u"."IntValue" = "r"."IntValue" OR "u"."IntValue" IS NULL AND "r"."IntValue" IS NULL) AND ("u"."IntValue" = "r"."IntValue" OR "u"."IntValue" IS NULL AND "r"."IntValue" IS NULL) AND '0' = "r"."BoolValue"
