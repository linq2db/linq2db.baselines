...
SELECT 1,CAST(_utf8 x'E280A9' AS VarChar(255) CHARACTER SET UNICODE_FSS) FROM rdb$database UNION ALL
SELECT 2,_utf8 x'20E280A920' FROM rdb$database UNION ALL
SELECT 3,_utf8 x'20E280A97820' FROM rdb$database
