...
FROM
	"Common_Topology_Locations" "x"
WHERE
	DateAdd(Millisecond, (Mod(CAST(@p AS BigInt), 864000000000) - Mod(Mod(CAST(@p AS BigInt), 864000000000), 10000)) / 10000, DateAdd(Day, (CAST(@p_1 AS BigInt) - Mod(CAST(@p_1 AS BigInt), 864000000000)) / 864000000000, "x"."StartDateTime2")) > TIMESTAMP '2026-08-04 16:59:59.3926'
...
FROM
	"Common_Topology_Locations" "x"
WHERE
	DateAdd(Millisecond, (Mod(CAST(@p AS BigInt), 864000000000) - Mod(Mod(CAST(@p AS BigInt), 864000000000), 10000)) / 10000, DateAdd(Day, (CAST(@p_1 AS BigInt) - Mod(CAST(@p_1 AS BigInt), 864000000000)) / 864000000000, "x"."StartDateTime2")) > TIMESTAMP '2026-08-04 16:59:59.3994'
