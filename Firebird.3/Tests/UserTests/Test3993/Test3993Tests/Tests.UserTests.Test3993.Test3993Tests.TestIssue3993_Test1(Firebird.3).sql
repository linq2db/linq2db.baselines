...
FROM
	"Common_Topology_Locations" "x"
WHERE
	DateAdd(Millisecond, 300000, "x"."StartDateTime2") > CAST('2025-08-31 17:52:48.101' AS timestamp)
...
FROM
	"Common_Topology_Locations" "x"
WHERE
	DateAdd(Millisecond, 3153600000000, "x"."StartDateTime2") > CAST('2025-08-31 17:52:48.106' AS timestamp)
