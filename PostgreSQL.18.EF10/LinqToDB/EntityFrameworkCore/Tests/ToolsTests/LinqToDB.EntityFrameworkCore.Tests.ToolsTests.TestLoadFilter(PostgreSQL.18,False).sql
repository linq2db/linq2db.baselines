...
LEFT JOIN (
    ...
    INNER JOIN (
        ...
        FROM "Orders" AS o0
        WHERE @ef_filter__p5 OR NOT (o0."IsDeleted") OR NOT (o0."IsDeleted")
    ...
    LEFT JOIN (
        SELECT s."SupplierID"
        FROM "Suppliers" AS s
        WHERE @ef_filter__p5 OR NOT (s."IsDeleted") OR NOT (s."IsDeleted")
    ...
    WHERE @ef_filter__p5 OR NOT (o."IsDeleted") OR NOT (o."IsDeleted")
