...
SET     @Id = 'da44c9e7-3c41-45f3-8795-be62fbac7eac'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = NULL
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 19, 17, 6, 8696841, 0, 0, 7)
...
-- SqlServer.2016
DECLARE @Id UniqueIdentifier -- Guid
SET     @Id = '6aac4022-a8e8-4d04-ac7b-efdf71734197'
DECLARE @ReferenceId UniqueIdentifier -- Guid
SET     @ReferenceId = 'da44c9e7-3c41-45f3-8795-be62fbac7eac'
DECLARE @DateTime DateTimeOffset
SET     @DateTime = DATETIMEOFFSETFROMPARTS(2024, 6, 14, 19, 17, 6, 8696841, 0, 0, 7)
...
SET     @key = 'da44c9e7-3c41-45f3-8795-be62fbac7eac'
