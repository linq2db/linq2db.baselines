...
WHERE
	NOT ("x_2"."Color" = '1' AND "x_2"."cond" = '1') OR
	NOT ("x_2"."Color" = '1' AND "x_2"."cond" = '1' AND "x_2"."Color_1" = '1' AND "x_2"."Color_1" IS NOT NULL)
...
WHERE
	NOT ("x_2"."Size_1" = '1' AND "x_2"."cond" = '0') OR
	NOT ("x_2"."Size_1" = '1' AND "x_2"."cond" = '0' AND "x_2"."Size_2" = '1' AND "x_2"."Size_2" IS NOT NULL)
