...
INSERT INTO l2dbnh_authors (name) VALUES (:p0) returning id;:p0 = 'Asimov' [Type: String (0:0:0)]

INSERT INTO l2dbnh_authors (name) VALUES (:p0) returning id;:p0 = 'Clarke' [Type: String (0:0:0)]

INSERT INTO l2dbnh_books (title) VALUES (:p0) returning id;:p0 = 'Foundation' [Type: String (0:0:0)]

INSERT INTO l2dbnh_books (title) VALUES (:p0) returning id;:p0 = 'I, Robot' [Type: String (0:0:0)]

INSERT INTO l2dbnh_books (title) VALUES (:p0) returning id;:p0 = '2001' [Type: String (0:0:0)]
