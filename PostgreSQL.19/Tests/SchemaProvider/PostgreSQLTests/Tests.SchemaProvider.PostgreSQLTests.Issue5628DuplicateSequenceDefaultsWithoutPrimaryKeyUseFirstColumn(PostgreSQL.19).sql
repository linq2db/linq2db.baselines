...
-- PostgreSQL.19 PostgreSQL12
CREATE TABLE issue5628_two_defaults_no_pk_110 (
	code integer DEFAULT nextval('issue5628_code_seq_110'::regclass) NOT NULL,
...
RollbackTransaction
-- PostgreSQL.19 PostgreSQL12
DROP TABLE IF EXISTS issue5628_two_defaults_no_pk_110
