...
-- PostgreSQL.19 PostgreSQL12
CREATE TABLE issue5628_two_defaults_pk_122 (
	...
	CONSTRAINT issue5628_two_defaults_pk_122_pkey PRIMARY KEY (item_id)
)
...
RollbackTransaction
-- PostgreSQL.19 PostgreSQL12
DROP TABLE IF EXISTS issue5628_two_defaults_pk_122
