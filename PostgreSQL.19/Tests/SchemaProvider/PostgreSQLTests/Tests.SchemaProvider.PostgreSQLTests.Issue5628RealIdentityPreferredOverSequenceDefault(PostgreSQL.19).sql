...
CREATE TABLE issue5628_real_identity_19 (
	code integer DEFAULT nextval('issue5628_code_seq_19'::regclass) NOT NULL,
...
DROP TABLE IF EXISTS issue5628_real_identity_19
