...
SET     @BoolValue = 1
DECLARE @BoolValueNullable SmallInt(4) -- Int16
...
(
	...
	CAST(@BoolValueNullable AS smallint),
	CAST(@StringValue AS NVarChar(1)),
	CAST(@StringValueNullable AS NVarChar(1))
)
...
(
	...
	CAST(@BoolValueNullable AS smallint),
	CAST(@StringValue AS NVarChar(1)),
	CAST(@StringValueNullable AS NVarChar(255))
)
