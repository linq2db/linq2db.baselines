...
FROM
	(
		...
		ON [g_1].[ParentID] = [a_ParentID2_1].[ParentID] AND ([g_1].[Value1] = [a_ParentID2_1].[Value1] AND [g_1].[Value1] IS NOT NULL AND [a_ParentID2_1].[Value1] IS NOT NULL OR [g_1].[Value1] IS NULL AND [a_ParentID2_1].[Value1] IS NULL)
