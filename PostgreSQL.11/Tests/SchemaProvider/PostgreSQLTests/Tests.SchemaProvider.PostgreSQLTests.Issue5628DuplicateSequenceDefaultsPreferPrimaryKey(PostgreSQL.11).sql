...
-- PostgreSQL.11 PostgreSQL
CREATE TABLE issue5628_two_defaults_pk_103 (
	code integer DEFAULT nextval('issue5628_code_seq_103'::regclass) NOT NULL,
	item_id integer DEFAULT nextval('issue5628_item_id_seq_103'::regclass) NOT NULL,
	CONSTRAINT issue5628_two_defaults_pk_103_pkey PRIMARY KEY (item_id)
)
...
RollbackTransaction
-- PostgreSQL.11 PostgreSQL
DROP TABLE IF EXISTS issue5628_two_defaults_pk_103
