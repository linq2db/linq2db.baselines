--  SqlServer.2008
DECLARE @p DateTime2
SET     @p = CAST('2024-11-19T10:09:53.0969433' AS DATETIME2)
...
--  SqlServer.2008
DECLARE @p DateTime2
SET     @p = CAST('2024-11-18T10:09:53.0972631' AS DATETIME2)
DECLARE @p_1 DateTime2
SET     @p_1 = CAST('2024-11-19T10:09:53.0972653' AS DATETIME2)
...
--  SqlServer.2008
DECLARE @p DateTime2
SET     @p = CAST('2024-11-18T10:09:53.0972701' AS DATETIME2)
DECLARE @p_1 DateTime2
SET     @p_1 = CAST('2024-11-19T10:09:53.0972702' AS DATETIME2)
...
--  SqlServer.2008
DECLARE @p DateTime2
SET     @p = CAST('2024-11-18T10:09:53.0972726' AS DATETIME2)
DECLARE @p_1 DateTime2
SET     @p_1 = CAST('2024-11-19T10:09:53.0972727' AS DATETIME2)
...
--  SqlServer.2008
DECLARE @p DateTime2
SET     @p = CAST('2024-11-19T10:09:53.1470281' AS DATETIME2)
DECLARE @p_1 DateTime2
SET     @p_1 = CAST('2024-11-18T10:09:53.1474613' AS DATETIME2)
DECLARE @p_2 DateTime2
SET     @p_2 = CAST('2024-11-19T10:09:53.1474644' AS DATETIME2)
DECLARE @p_3 DateTime2
SET     @p_3 = CAST('2024-11-18T10:09:53.1478388' AS DATETIME2)
DECLARE @p_4 DateTime2
SET     @p_4 = CAST('2024-11-19T10:09:53.1478407' AS DATETIME2)
DECLARE @p_5 DateTime2
SET     @p_5 = CAST('2024-11-18T10:09:53.1481445' AS DATETIME2)
DECLARE @p_6 DateTime2
SET     @p_6 = CAST('2024-11-19T10:09:53.1481462' AS DATETIME2)
