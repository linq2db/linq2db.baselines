...
SET     @Id = 1
DECLARE @DealNumber Integer(4) -- Int32
SET     @DealNumber = 2
DECLARE @ParcelGroupID Integer(4) -- Int32
SET     @ParcelGroupID = 3
DECLARE @ParcelID Integer(4) -- Int32
SET     @ParcelID = 4
...
DECLARE @Id Integer(4) -- Int32
SET     @Id = 1
DECLARE @DeliveryDealNumber Integer(4) -- Int32
SET     @DeliveryDealNumber = 2
DECLARE @DeliveryParcelGroup Integer(4) -- Int32
SET     @DeliveryParcelGroup = 3
DECLARE @DeliveryParcelID Integer(4) -- Int32
SET     @DeliveryParcelID = 4
DECLARE @ReceiptDealNumber Integer(4) -- Int32
SET     @ReceiptDealNumber = 9
DECLARE @ReceiptParcelGroup Integer(4) -- Int32
SET     @ReceiptParcelGroup = 9
DECLARE @ReceiptParcelID Integer(4) -- Int32
