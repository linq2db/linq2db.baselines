...
WHERE
	t_1.RuleNo IS NOT NULL AND t_1.CarNo LIKE '%1%' ESCAPE '~' AND
	t_1.CarBrand LIKE '%test%' ESCAPE '~'
...
WHERE
	t1.RuleNo IS NOT NULL AND t1.CarNo LIKE '%1%' ESCAPE '~' AND
	t1.CarBrand LIKE '%test%' ESCAPE '~'
