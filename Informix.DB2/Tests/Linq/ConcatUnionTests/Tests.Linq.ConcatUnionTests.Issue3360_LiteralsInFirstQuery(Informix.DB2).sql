...
FROM
	(
		SELECT
			...
			5::SmallInt as c1,
			5::SmallInt as c2,
			'0b8afe27-481c-442e-b8cf-729ddfeece29'::VARCHAR(36) as c3,
			'0b8afe27-481c-442e-b8cf-729ddfeece30'::VARCHAR(36) as c4,
			'ENUM1_VALUE'::NChar(11) as c5,
			'ENUM2_VALUE'::NChar(11) as c6,
			't'::BOOLEAN as c7,
			'f'::BOOLEAN as c8
		FROM
			Issue3360Table1 r
