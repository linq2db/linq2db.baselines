...
SELECT
	...
	(
		...
		WHERE
			([nomin_4].[DeliveryCounterParty] LIKE @cpty OR [trade_4].[CounterParty] LIKE @cpty_1 OR [t1].[AlertCode] LIKE @cpty_2) AND
	...
	(
		...
		WHERE
			([nomin_6].[DeliveryCounterParty] LIKE @cpty_3 OR [trade_6].[CounterParty] LIKE @cpty_4 OR [t2].[AlertCode] LIKE @cpty_5) AND
	...
	(
		...
		WHERE
			([nomin_8].[DeliveryCounterParty] LIKE @cpty_6 OR [trade_8].[CounterParty] LIKE @cpty_7 OR [t3].[AlertCode] LIKE @cpty_8) AND
	...
	(
		...
		WHERE
			([nomin_10].[DeliveryCounterParty] LIKE @cpty_9 OR [trade_10].[CounterParty] LIKE @cpty_10 OR [t4].[AlertCode] LIKE @cpty_11) AND
	...
	(
		...
		WHERE
			([nomin_12].[DeliveryCounterParty] LIKE @cpty_12 OR [trade_12].[CounterParty] LIKE @cpty_13 OR [t5].[AlertCode] LIKE @cpty_14) AND
	...
	(
		...
		WHERE
			([nomin_14].[DeliveryCounterParty] LIKE @cpty_15 OR [trade_14].[CounterParty] LIKE @cpty_16 OR [t6].[AlertCode] LIKE @cpty_17) AND
	...
	(
		...
		WHERE
			([nomin_16].[DeliveryCounterParty] LIKE @cpty_18 OR [trade_16].[CounterParty] LIKE @cpty_19 OR [t7].[AlertCode] LIKE @cpty_20) AND
	...
	(
		...
		WHERE
			([nomin_18].[DeliveryCounterParty] LIKE @cpty_21 OR [trade_18].[CounterParty] LIKE @cpty_22 OR [t8].[AlertCode] LIKE @cpty_23) AND
...
WHERE
	([nomin_2].[DeliveryCounterParty] LIKE @cpty_24 OR [trade_2].[CounterParty] LIKE @cpty_25 OR [al_group_1].[AlertCode] LIKE @cpty_26)
GROUP BY
	[al_group_1].[AlertKey],
	[al_group_1].[AlertCode],
