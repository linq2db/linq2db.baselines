...
FROM
	LinqDataTypes t
WHERE
	t.ID = 5000 AND t.DateTimeValue + CAST(((t.SmallIntValue + CAST($part1 AS INTEGER)) - CAST($part2 AS INTEGER)) * Interval '1 Day' AS INTERVAL) > make_timestamp(2018, 1, 2, 0, 0, 0)
