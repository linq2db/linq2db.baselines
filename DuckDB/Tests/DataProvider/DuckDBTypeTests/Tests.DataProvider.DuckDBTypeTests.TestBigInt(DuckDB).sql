...
FROM
	"TypeTable`2" r
WHERE
	r."Column" = CAST($value AS BIGINT) AND r.ColumnNullable IS NULL
...
FROM
	"TypeTable`2" r
WHERE
	r."Column" = CAST($value AS BIGINT) AND r.ColumnNullable = CAST($nullableValue AS BIGINT)
...
SET     $value = '-9223372036854775808'
DECLARE $nullableValue NVarChar(19) -- String
SET     $nullableValue = '9223372036854775807'
...
SET     $Column = '-9223372036854775808'
DECLARE $ColumnNullable NVarChar(19) -- String
SET     $ColumnNullable = '9223372036854775807'
...
FROM
	"TypeTable`2" r
WHERE
	r."Column" = '16777216'::FLOAT AND r.ColumnNullable = '-16777216'::FLOAT
...
FROM
	"TypeTable`2" r
WHERE
	r."Column" = 9007199254740991 AND r.ColumnNullable = -9007199254740991
