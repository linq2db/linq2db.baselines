...
SET     $value = 'null'
DECLARE $nullableValue NVarChar(4) -- String
...
DECLARE $Id  -- Int32
SET     $Id = 1
DECLARE $Column NVarChar(4) -- String
SET     $Column = 'null'
DECLARE $ColumnNullable NVarChar(4) -- String
SET     $ColumnNullable = 'null'
...
DECLARE $p1  -- Int32
SET     $p1 = 1
DECLARE $p2 NVarChar(4) -- String
SET     $p2 = 'null'
DECLARE $p3 NVarChar(4) -- String
SET     $p3 = 'null'
...
FROM
	"TypeTable`2" r
WHERE
	r."Column" = '"test"' AND r.ColumnNullable = '123'
...
FROM
	"TypeTable`2" r
WHERE
	r."Column" = '{"ы": 1.23}' AND r.ColumnNullable = '{"prop": false }'
