...
IF (OBJECT_ID(N'Tdm100') IS NOT NULL)
	DROP TABLE [Tdm100]

BeforeExecute
-- Sybase.Managed Sybase

IF (OBJECT_ID(N'Tdm100') IS NULL)
	EXECUTE('
		CREATE TABLE [Tdm100]
		(
			[Id]          Int          NOT NULL,
...
IF (OBJECT_ID(N'Trp004') IS NOT NULL)
	DROP TABLE [Trp004]

BeforeExecute
-- Sybase.Managed Sybase

IF (OBJECT_ID(N'Trp004') IS NULL)
	EXECUTE('
		CREATE TABLE [Trp004]
		(
			[Id]              Int          NOT NULL,
...
IF (OBJECT_ID(N'Trp003') IS NOT NULL)
	DROP TABLE [Trp003]

BeforeExecute
-- Sybase.Managed Sybase

IF (OBJECT_ID(N'Trp003') IS NULL)
	EXECUTE('
		CREATE TABLE [Trp003]
		(
			[Id]       Int          NOT NULL,
...
IF (OBJECT_ID(N'Trp0041') IS NOT NULL)
	DROP TABLE [Trp0041]

BeforeExecute
-- Sybase.Managed Sybase

IF (OBJECT_ID(N'Trp0041') IS NULL)
	EXECUTE('
...
BeforeExecute
-- Sybase.Managed Sybase
DECLARE @carNo UniVarChar(3) -- String
SET     @carNo = '%1%'
DECLARE @carBrand UniVarChar(6) -- String
SET     @carBrand = '%test%'
