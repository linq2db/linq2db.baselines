...
SELECT uBigintDataType FROM AllTypes WHERE ID = 1

BeforeExecute
-- Sybase.Managed Sybase

SELECT uBigintDataType FROM AllTypes WHERE ID = 2
...
SELECT uSmallintDataType FROM AllTypes WHERE ID = 1

BeforeExecute
-- Sybase.Managed Sybase

SELECT uSmallintDataType FROM AllTypes WHERE ID = 2
...
SELECT uIntDataType FROM AllTypes WHERE ID = 1

BeforeExecute
-- Sybase.Managed Sybase

SELECT uIntDataType FROM AllTypes WHERE ID = 2
