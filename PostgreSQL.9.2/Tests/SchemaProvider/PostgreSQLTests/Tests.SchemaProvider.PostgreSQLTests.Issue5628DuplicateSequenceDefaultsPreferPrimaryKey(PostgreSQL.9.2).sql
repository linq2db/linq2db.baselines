...
-- PostgreSQL.9.2 PostgreSQL
CREATE TABLE issue5628_two_defaults_pk_93 (
	...
	CONSTRAINT issue5628_two_defaults_pk_93_pkey PRIMARY KEY (item_id)
)
...
RollbackTransaction
-- PostgreSQL.9.2 PostgreSQL
DROP TABLE IF EXISTS issue5628_two_defaults_pk_93
