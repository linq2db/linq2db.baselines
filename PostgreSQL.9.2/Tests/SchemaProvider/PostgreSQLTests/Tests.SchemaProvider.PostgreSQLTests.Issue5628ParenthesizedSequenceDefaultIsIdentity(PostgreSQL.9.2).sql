...
-- PostgreSQL.9.2 PostgreSQL
CREATE TABLE issue5628_parenthesized_default_95 (
...
FROM pg_attrdef
WHERE adrelid = 'issue5628_parenthesized_default_95'::regclass
AND adnum = 1
...
RollbackTransaction
-- PostgreSQL.9.2 PostgreSQL
DROP TABLE IF EXISTS issue5628_parenthesized_default_95
