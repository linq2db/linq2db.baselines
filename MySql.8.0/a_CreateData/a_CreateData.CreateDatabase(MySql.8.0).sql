...
VALUES
(1,CAST(1.11 AS DECIMAL(3, 2)),'2001-01-11 01:11:21.100',NULL,1,'ef129165-6ffe-4df9-bb6b-bb16e413c883',1,NULL,CAST(1 AS SIGNED),NULL),
(2,CAST(2.49 AS DECIMAL(3, 2)),'2005-05-15 05:15:25.500',NULL,0,'bc663a61-7b40-4681-ac38-f9aaf55b706b',2,NULL,CAST(2 AS SIGNED),''),
(3,CAST(3.99 AS DECIMAL(3, 2)),'2009-09-19 09:19:29.090',NULL,1,'d2f970c0-35ac-4987-9cd5-5badb1757436',3,NULL,NULL,'1'),
(4,CAST(4.50 AS DECIMAL(3, 2)),'2009-09-20 09:19:29.090',NULL,0,'40932fdb-1543-4e4a-ac2c-ca371604fb4b',4,NULL,NULL,'2'),
(5,CAST(5.50 AS DECIMAL(3, 2)),'2009-09-20 09:19:29.090',NULL,1,'febe3eca-cb5f-40b2-ad39-2979d312afca',5,NULL,NULL,'3'),
(6,CAST(6.55 AS DECIMAL(3, 2)),'2009-09-22 09:19:29.090',NULL,0,'8d3c5d1d-47db-4730-9fe7-968f6228a4c0',6,NULL,NULL,'4'),
(7,CAST(7.00 AS DECIMAL(3, 2)),'2009-09-23 09:19:29.090',NULL,1,'48094115-83af-46dd-a906-bff26ee21ee2',7,NULL,NULL,'5'),
(8,CAST(8.99 AS DECIMAL(3, 2)),'2009-09-24 09:19:29.090',NULL,0,'c1139f1f-1335-4cd4-937e-92602f732dd3',8,NULL,NULL,'6'),
(9,CAST(9.63 AS DECIMAL(3, 2)),'2009-09-25 09:19:29.090',NULL,1,'46c5c512-3d4b-4cf7-b4e7-1de080789e5d',9,NULL,NULL,'7'),
(10,CAST(10.77 AS DECIMAL(4, 2)),'2009-09-26 09:19:29.090',NULL,0,'61b2bc55-147f-4b40-93ed-a4aa83602fee',10,NULL,NULL,'8'),
(11,CAST(11.45 AS DECIMAL(4, 2)),'2009-09-27',NULL,1,'d3021d18-97f0-4dc0-98d0-f0c7df4a1230',11,NULL,NULL,'9'),
(12,CAST(11.45 AS DECIMAL(4, 2)),'2012-11-07 19:19:29.090',NULL,1,'03021d18-97f0-4dc0-98d0-f0c7df4a1230',12,NULL,NULL,'0')
