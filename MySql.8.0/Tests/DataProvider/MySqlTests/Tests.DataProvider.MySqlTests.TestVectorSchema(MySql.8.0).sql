...
DROP PROCEDURE IF EXISTS VectorProc

-- MySql.8.0 MySql.8.0.MySql.Data MySql80

CREATE PROCEDURE VectorProc (IN vin VECTOR(3), OUT vout VECTOR(3))
BEGIN
...
-- MySql.8.0 MySql.8.0.MySql.Data MySql80
DECLARE @vin Vector(3) -- String
SET     @vin = NULL
DECLARE @vout Vector(3) -- String
SET     @vout = NULL
