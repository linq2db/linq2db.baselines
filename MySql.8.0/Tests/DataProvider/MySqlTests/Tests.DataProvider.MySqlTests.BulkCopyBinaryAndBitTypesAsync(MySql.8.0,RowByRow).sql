...
SET     @Id = 2
DECLARE @Bit_1 UInt64
SET     @Bit_1 = CAST(18446744073709551615 AS UNSIGNED)
DECLARE @Bit_2 UInt64
SET     @Bit_2 = CAST(9223372036854775807 AS SIGNED)
DECLARE @Bit_3 UInt64
SET     @Bit_3 = CAST(18446744073709551615 AS UNSIGNED)
DECLARE @Bit_4 UInt64
SET     @Bit_4 = CAST(1073741823 AS UNSIGNED INT)
DECLARE @Bit_5 UInt64
SET     @Bit_5 = 1
DECLARE @Bit_6 UInt64
SET     @Bit_6 = CAST(1 AS UNSIGNED)
