...
SET     @userId = '10e092cc-034f-4e44-bac4-24951f9a0b95'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 31, 8, 1, 36, 4410394, 7)
...
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 31, 8, 1, 36, 4410394, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 31, 8, 1, 36, 4410394, 7)
...
-- SqlServer.Contained.MS SqlServer.2019
DECLARE @userId UniqueIdentifier -- Guid
SET     @userId = 'c0407497-c269-4339-9adb-7a89daab70f4'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 31, 8, 1, 36, 5355879, 7)
...
SET     @userId = 'c0407497-c269-4339-9adb-7a89daab70f4'
DECLARE @now_1 DateTime2
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 31, 8, 1, 36, 5355879, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 31, 8, 1, 36, 5355879, 7)
