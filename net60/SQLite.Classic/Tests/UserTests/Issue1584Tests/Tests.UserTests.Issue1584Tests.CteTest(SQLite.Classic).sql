...
(
	SELECT
		...
		[_].[TI_Frequency],
		[_].[TI_OH_Supplier],
		[_].[TI_OH_TransportProvider],
		[_].[TI_OH_Consignor],
		[_].[TI_OH_Consignee],
		[_].[TI_OA_CartagePickupAddressOverride],
		[_].[TI_OA_CartageDeliveryAddressOverride],
		[_].[TI_CartagePickupAddressPostCode],
		[_].[TI_CartageDeliveryAddressPostCode],
		[_].[TI_RS_NKServiceLevel_NI],
		[_].[TI_OriginLRC],
		[_].[TI_DestinationLRC],
		[_].[TI_ViaLRC],
		[_].[TI_PageHeading],
		[_].[TI_PageOpeningText],
		[_].[TI_PageClosingText],
		[_].[TI_OH_AgentOverride],
		[_].[TI_ParentID],
		[_].[TI_QuotePageIncoTerm],
		[_].[TI_BuyersConsolRateMode],
		[_].[TI_SystemCreateTimeUtc],
		[_].[TI_SystemCreateUser],
		[_].[TI_SystemLastEditTimeUtc],
		[_].[TI_SystemLastEditUser],
		[_].[TI_TH],
		[_].[TI_RC],
		[_].[TI_ContractNumber],
		[_].[TI_PL_NKCarrierServiceLevel],
		[_].[TI_TZ_OriginZone],
		[_].[TI_TZ_DestinationZone],
		[_].[TI_IsValid],
		[_].[TI_IsCrossTrade],
		[_].[TI_DataChecked],
		[_].[TI_MatchContainerRateClass],
		[_].[TI_TransitTime],
		[_].[TI_FrequencyUnit],
		[_].[TI_Mode],
		[_].[TI_RH_NKCommodityCode],
		[_].[TI_RateCategory],
		[_].[TI_FromID],
		[_].[TI_FromTableCode],
		[_].[TI_ToId],
		[_].[TI_ToTableCode],
		[_].[TI_OH_ControllingCustomer],
		[_].[TI_GC_Publisher],
		[_].[TI_IsTact],
		[_].[TI_ParentTableCode],
		[_].[TI_RateKey],
		Sum(CASE
			WHEN [rateLineItem_1].[TM_Type] IN ('FLT', 'BAS')
	...
	FROM
		[RateEntry] [_]
			LEFT JOIN [RateLines] [rateLine] ON [rateLine].[TL_TI] = [_].[TI_PK]
	...
	WHERE
		([_].[TI_RateEndDate] IS NULL OR DateTime([_].[TI_RateEndDate]) > DateTime(CURRENT_TIMESTAMP)) AND
