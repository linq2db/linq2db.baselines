...
VALUES
(3,DATETIMEFROMPARTS(2020, 2, 29, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 17, 54, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 2, 29, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 0, 0, 7),@p1,@p2,@p3),
(4,DATETIMEFROMPARTS(2020, 3, 1, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 17, 55, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 3, 1, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 1, 0, 7),@p4,@p5,@p6),
(5,DATETIMEFROMPARTS(2020, 3, 2, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 17, 56, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 3, 2, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 2, 0, 7),@p7,@p8,@p9),
(6,DATETIMEFROMPARTS(2020, 3, 3, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 17, 57, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 3, 3, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 3, 0, 7),@p10,@p11,@p12),
(7,DATETIMEFROMPARTS(2020, 3, 4, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 17, 58, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 3, 4, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 4, 0, 7),@p13,@p14,@p15),
(8,DATETIMEFROMPARTS(2020, 3, 5, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 17, 59, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 3, 5, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 5, 0, 7),@p16,@p17,@p18),
(9,DATETIMEFROMPARTS(2020, 3, 6, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 18, 0, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 3, 6, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 6, 0, 7),@p19,@p20,@p21),
(10,DATETIMEFROMPARTS(2020, 3, 7, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 18, 1, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 3, 7, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 7, 0, 7),@p22,@p23,@p24),
(11,DATETIMEFROMPARTS(2020, 3, 8, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 18, 2, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 3, 8, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 8, 0, 7),@p25,@p26,@p27),
(12,DATETIMEFROMPARTS(2020, 3, 9, 0, 0, 0, 0),DATETIMEOFFSETFROMPARTS(2020, 2, 29, 18, 3, 55, 1231234, 0, 0, 7),DATETIMEFROMPARTS(2020, 3, 9, 0, 0, 0, 0),TIMEFROMPARTS(0, 0, 9, 0, 7),@p28,@p29,@p30)
