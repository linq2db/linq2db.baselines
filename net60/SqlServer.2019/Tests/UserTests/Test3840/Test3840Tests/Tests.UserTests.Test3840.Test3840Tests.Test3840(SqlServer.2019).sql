...
VALUES
(DATETIME2FROMPARTS(2023, 2, 6, 18, 41, 51, 7376746, 7),CAST(20000000000 AS BIGINT),TIMEFROMPARTS(0, 33, 20, 0, 7),TIMEFROMPARTS(0, 33, 20, 0, 7),DATETIME2FROMPARTS(2023, 2, 6, 0, 0, 0, 0, 7))
