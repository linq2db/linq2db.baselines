...
SET     @userId = 'd95442e4-3758-4e62-897a-3aac30cd33e7'::uuid
DECLARE @now Timestamp -- DateTime2
SET     @now = '2023-08-30 17:49:00.965'::timestamp
...
SET     @now_1 = '2023-08-30 17:49:00.965'::timestamp
DECLARE @now_2 Timestamp -- DateTime2
SET     @now_2 = '2023-08-30 17:49:00.965'::timestamp
...
-- PostgreSQL.12 PostgreSQL.9.5 PostgreSQL
DECLARE @userId Uuid -- Guid
SET     @userId = 'ac0763c6-7538-48ac-b017-27d2761faed9'::uuid
DECLARE @now Timestamp -- DateTime2
SET     @now = '2023-08-30 17:49:01.037'::timestamp
...
SET     @userId = 'ac0763c6-7538-48ac-b017-27d2761faed9'::uuid
DECLARE @now_1 Timestamp -- DateTime2
SET     @now_1 = '2023-08-30 17:49:01.037'::timestamp
DECLARE @now_2 Timestamp -- DateTime2
SET     @now_2 = '2023-08-30 17:49:01.037'::timestamp
