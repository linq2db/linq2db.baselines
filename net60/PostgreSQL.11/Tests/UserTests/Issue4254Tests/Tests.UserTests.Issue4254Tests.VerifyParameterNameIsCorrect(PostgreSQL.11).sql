...
SET     @userId = 'f45d0eaf-1544-468d-8b68-2a97fa4251ca'::uuid
DECLARE @now Timestamp -- DateTime2
SET     @now = '2023-08-30 17:48:46.195'::timestamp
...
SET     @now_1 = '2023-08-30 17:48:46.195'::timestamp
DECLARE @now_2 Timestamp -- DateTime2
SET     @now_2 = '2023-08-30 17:48:46.195'::timestamp
...
-- PostgreSQL.11 PostgreSQL.9.5 PostgreSQL
DECLARE @userId Uuid -- Guid
SET     @userId = 'e40484fe-8338-446f-9b4f-45079e527db7'::uuid
DECLARE @now Timestamp -- DateTime2
SET     @now = '2023-08-30 17:48:46.265'::timestamp
...
SET     @userId = 'e40484fe-8338-446f-9b4f-45079e527db7'::uuid
DECLARE @now_1 Timestamp -- DateTime2
SET     @now_1 = '2023-08-30 17:48:46.265'::timestamp
DECLARE @now_2 Timestamp -- DateTime2
SET     @now_2 = '2023-08-30 17:48:46.265'::timestamp
