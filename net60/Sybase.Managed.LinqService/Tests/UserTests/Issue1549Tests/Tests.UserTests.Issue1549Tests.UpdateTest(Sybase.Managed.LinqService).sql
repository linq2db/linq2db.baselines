...
IF (OBJECT_ID(N'billing_devtypes') IS NULL)
	EXECUTE('
...
IF (OBJECT_ID(N'billing_devices') IS NULL)
	EXECUTE('
...
IF (OBJECT_ID(N'billing_DevReadingType') IS NULL)
	EXECUTE('
...
IF (OBJECT_ID(N'billing_TempReading') IS NULL)
	EXECUTE('
