	...
	[Table5] [t1]
		INNER JOIN [Table4] [cp]
			INNER JOIN [Table1] [c_1]
				LEFT JOIN [Table4] [a_Table4Ref]
					LEFT JOIN [Table5] [a_Table5Ref] ON [a_Table4Ref].[Field4] = [a_Table5Ref].[ProblematicalField]
				ON [c_1].[Field3] = [a_Table4Ref].[Field3]
			ON [cp].[Field3] = [c_1].[Field3]
			LEFT JOIN [Table5] [a_Table5Ref_1] ON [a_Table5Ref].[Field5] = [a_Table5Ref_1].[ProblematicalField]
		...
		LEFT JOIN [Table5] [a_Table5Ref_2] ON [t1].[Field5] = [a_Table5Ref_2].[ProblematicalField]
