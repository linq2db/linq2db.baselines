...
BeforeExecute
-- Access AccessOleDb
DECLARE @p UnsignedTinyInt(1) -- Byte
SET     @p = 1
...
BeforeExecute
-- Access AccessOleDb
DECLARE @p UnsignedTinyInt -- Byte
SET     @p = NULL
...
BeforeExecute
-- Access AccessOleDb
DECLARE @p UnsignedSmallInt -- UInt16
SET     @p = 1
...
BeforeExecute
-- Access AccessOleDb
DECLARE @p UnsignedBigInt -- UInt64
SET     @p = 1
...
BeforeExecute
-- Access AccessOleDb
DECLARE @p VarChar(28, 10) -- AnsiString
SET     @p = 1
