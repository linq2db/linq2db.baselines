...
CREATE SEQUENCE issue5628_code_seq_101
...
CREATE TABLE issue5628_two_defaults_pk_101 (
	code integer DEFAULT nextval('issue5628_code_seq_101'::regclass) NOT NULL,
	item_id integer DEFAULT nextval('issue5628_item_id_seq_101'::regclass) NOT NULL,
	CONSTRAINT issue5628_two_defaults_pk_101_pkey PRIMARY KEY (item_id)
)
...
DROP TABLE IF EXISTS issue5628_two_defaults_pk_101

-- PostgreSQL.16 PostgreSQL.15 PostgreSQL13

DROP SEQUENCE IF EXISTS issue5628_code_seq_101
