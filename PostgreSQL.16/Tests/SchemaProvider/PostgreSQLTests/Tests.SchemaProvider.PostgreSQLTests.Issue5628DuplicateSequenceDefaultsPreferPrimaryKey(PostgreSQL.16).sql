...
-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
CREATE TABLE issue5628_two_defaults_pk_125 (
	...
	CONSTRAINT issue5628_two_defaults_pk_125_pkey PRIMARY KEY (item_id)
)
...
RollbackTransaction
-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
DROP TABLE IF EXISTS issue5628_two_defaults_pk_125
