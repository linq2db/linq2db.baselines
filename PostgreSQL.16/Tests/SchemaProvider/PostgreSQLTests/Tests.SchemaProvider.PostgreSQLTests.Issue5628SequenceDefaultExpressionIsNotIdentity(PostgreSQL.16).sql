...
CREATE TABLE issue5628_sample_messages_105 (
	code character varying(255) DEFAULT ('PREFIX_'::text || nextval('issue5628_code_seq_105'::regclass)) NOT NULL,
	...
	CONSTRAINT issue5628_sample_messages_105_pkey PRIMARY KEY (item_id, item_type),
	CONSTRAINT issue5628_sample_messages_105_code_key UNIQUE (code)
)
...
DROP TABLE IF EXISTS issue5628_sample_messages_105
