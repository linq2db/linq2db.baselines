...
-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
CREATE TABLE issue5628_two_defaults_no_pk_115 (
	code integer DEFAULT nextval('issue5628_code_seq_115'::regclass) NOT NULL,
...
RollbackTransaction
-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
DROP TABLE IF EXISTS issue5628_two_defaults_no_pk_115
