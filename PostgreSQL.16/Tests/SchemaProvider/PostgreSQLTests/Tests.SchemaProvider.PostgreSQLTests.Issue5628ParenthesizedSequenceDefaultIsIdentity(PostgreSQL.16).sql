...
CREATE SEQUENCE issue5628_item_id_seq_138

-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
CREATE TABLE issue5628_parenthesized_default_138 (
	item_id integer DEFAULT (nextval('issue5628_item_id_seq_138'::regclass)) NOT NULL
)

-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
SELECT pg_get_expr(adbin, adrelid)
FROM pg_attrdef
WHERE adrelid = 'issue5628_parenthesized_default_138'::regclass
AND adnum = 1
...
RollbackTransaction
-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
DROP TABLE IF EXISTS issue5628_parenthesized_default_138

-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
DROP SEQUENCE IF EXISTS issue5628_item_id_seq_138
