...
-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
CREATE TABLE issue5628_parenthesized_default_117 (
...
FROM pg_attrdef
WHERE adrelid = 'issue5628_parenthesized_default_117'::regclass
AND adnum = 1
...
RollbackTransaction
-- PostgreSQL.16 PostgreSQL.15 PostgreSQL12
DROP TABLE IF EXISTS issue5628_parenthesized_default_117
