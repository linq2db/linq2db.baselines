...
CREATE TABLE issue5628_parenthesized_default_103 (
...
FROM pg_attrdef
WHERE adrelid = 'issue5628_parenthesized_default_103'::regclass
AND adnum = 1
...
DROP TABLE IF EXISTS issue5628_parenthesized_default_103
