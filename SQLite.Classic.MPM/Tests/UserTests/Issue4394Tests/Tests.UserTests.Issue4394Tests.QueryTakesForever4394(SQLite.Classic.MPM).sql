...
SELECT
	...
	[a1].[Id] IS NOT NULL AND ([a1].[Id] <> X'00000000000000000000000000000000' OR [a1].[Id] IS NULL),
	[a1].[Id],
	[c1].[Id],
	[c1].[ResourceLabel],
	[c1].[Status],
...
SELECT
	...
	[a2].[Id] IS NOT NULL AND ([a2].[Id] <> X'00000000000000000000000000000000' OR [a2].[Id] IS NULL),
	[a2].[Id],
	[c2].[Id],
	[c2].[ResourceLabel],
	[c2].[Status],
	...
	[a3].[Id] IS NOT NULL AND ([a3].[Id] <> X'00000000000000000000000000000000' OR [a3].[Id] IS NULL),
	[a3].[Id],
	[c3].[Id],
	[c3].[ResourceLabel],
	[c3].[Status],
	...
	[a4].[Id] IS NOT NULL AND ([a4].[Id] <> X'00000000000000000000000000000000' OR [a4].[Id] IS NULL),
	[a4].[Id],
	[c4].[Id],
	[c4].[ResourceLabel],
	[c4].[Status],
	...
	[a5].[Id] IS NOT NULL AND ([a5].[Id] <> X'00000000000000000000000000000000' OR [a5].[Id] IS NULL),
	[a5].[Id],
	[c5].[Id],
	[c5].[ResourceLabel],
	[c5].[Status],
	...
	[a6].[Id] IS NOT NULL AND ([a6].[Id] <> X'00000000000000000000000000000000' OR [a6].[Id] IS NULL),
	[a6].[Id],
	[c6].[Id],
	[c6].[ResourceLabel],
	[c6].[Status],
	...
	[a7].[Id] IS NOT NULL AND ([a7].[Id] <> X'00000000000000000000000000000000' OR [a7].[Id] IS NULL),
	[a7].[Id],
	[c7].[Id],
	[c7].[ResourceLabel],
	[c7].[Status],
	...
	[a8].[Id] IS NOT NULL AND ([a8].[Id] <> X'00000000000000000000000000000000' OR [a8].[Id] IS NULL),
	[a8].[Id],
	[c8].[Id],
	[c8].[ResourceLabel],
	[c8].[Status],
