...
(
	...
	WHERE
		`ncGroupMember`.`NC_GROUP_BO` = Concat('NCGroupBO:', `ncCode`.`SITE`, ',CATAN_AUTO') AND `ncGroupMember`.`NC_GROUP_BO` IS NOT NULL AND Concat('NCGroupBO:', `ncCode`.`SITE`, ',CATAN_AUTO') IS NOT NULL OR
		`ncGroupMember`.`NC_GROUP_BO` IS NULL AND Concat('NCGroupBO:', `ncCode`.`SITE`, ',CATAN_AUTO') IS NULL OR
		`ncGroupMember`.`NC_GROUP_BO` = Concat('NCGroupBO:', `ncCode`.`SITE`, ',CATAN_MAN') AND `ncGroupMember`.`NC_GROUP_BO` IS NOT NULL AND Concat('NCGroupBO:', `ncCode`.`SITE`, ',CATAN_MAN') IS NOT NULL OR
		`ncGroupMember`.`NC_GROUP_BO` IS NULL AND Concat('NCGroupBO:', `ncCode`.`SITE`, ',CATAN_MAN') IS NULL OR
		`ncGroupMember`.`NC_GROUP_BO` = Concat('NCGroupBO:', `ncCode`.`SITE`, ',CATAN_ALL') AND `ncGroupMember`.`NC_GROUP_BO` IS NOT NULL AND Concat('NCGroupBO:', `ncCode`.`SITE`, ',CATAN_ALL') IS NOT NULL OR
		`ncGroupMember`.`NC_GROUP_BO` IS NULL AND Concat('NCGroupBO:', `ncCode`.`SITE`, ',CATAN_ALL') IS NULL
)
SELECT
	`item_1`.`NcCodeBo`,
	`item_1`.`NcCode`,
