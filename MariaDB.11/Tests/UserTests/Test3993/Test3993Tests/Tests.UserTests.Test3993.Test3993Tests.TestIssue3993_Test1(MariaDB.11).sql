...
FROM
	`Common_Topology_Locations` `x`
WHERE
	Date_Add(`x`.`StartDateTime2`, Interval (@Value * 1000) Microsecond) > '2025-08-31 17:58:43.601'
...
FROM
	`Common_Topology_Locations` `x`
WHERE
	Date_Add(`x`.`StartDateTime2`, Interval (@Value * 1000) Microsecond) > '2025-08-31 17:58:43.607'
