...
USING (
	SELECT 3 AS "Id", -123 AS "FieldInt32", CAST(987 AS BigInt) AS "FieldInt64", CAST(NULL AS BOOLEAN) AS "FieldBoolean", CAST('<>?/.,;''zZ":' AS VARCHAR(12)) AS "FieldString", CAST('`~!@#$%^&*()_+{}|[]\' AS VARCHAR(20)) AS "FieldNString", '' AS "FieldChar", '' AS "FieldNChar", CAST(-1.17549996E-38 AS Real) AS "FieldFloat", CAST('2098-10-12 21:14:15.907' AS timestamp) AS "FieldDateTime", X'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF' AS "FieldGuid", CAST(-0.123 AS Decimal(3, 3)) AS "FieldDecimal", CAST('2111-11-23' AS timestamp) AS "FieldDate", NULL AS "FieldEnumString", -2147483647 AS "FieldEnumNumber" FROM rdb$database
	UNION ALL
