...
SET
	"UpdatedEntities"."Value1" = (
		...
		WHERE
			"t"."id" <> :"someId_3" AND "UpdatedEntities"."id" = "c_1"."id"
	),
	"UpdatedEntities"."Value2" = (
		...
		WHERE
			"t_1"."id" <> :"someId_3_1" AND "UpdatedEntities"."id" = "c_2"."id"
	),
	"UpdatedEntities"."Value3" = (
		...
		WHERE
			"t_2"."id" <> :"someId_3_2" AND "UpdatedEntities"."id" = "c_3"."id"
	)
WHERE
	EXISTS(
		SELECT
		...
		WHERE
			"t_3"."id" <> :"someId_3_3" AND "UpdatedEntities"."id" = "c_4"."id"
	)
