...
DECLARE @int2  -- Int32
SET     @int2 = 22
DECLARE @someId_3_1  -- Int32
SET     @someId_3_1 = 100
DECLARE @int3  -- Int32
SET     @int3 = 33
DECLARE @someId_3_2  -- Int32
SET     @someId_3_2 = 100
DECLARE @someId_3_3  -- Int32
SET     @someId_3_3 = 100
...
SET
	"UpdatedEntities"."Value1" = (
		...
		FROM
			...
			"NewEntities" "t"
		WHERE
			"t"."id" = "c_1"."id" AND "t"."id" <> :"someId_3" AND
			"UpdatedEntities"."id" = "c_1"."id"
	),
	"UpdatedEntities"."Value2" = (
		...
		FROM
			...
			"NewEntities" "t_1"
		WHERE
			"t_1"."id" = "c_2"."id" AND "t_1"."id" <> :"someId_3_1" AND
	...
	"UpdatedEntities"."Value3" = (
		...
		FROM
			...
			"NewEntities" "t_2"
		WHERE
			"t_2"."id" = "c_3"."id" AND "t_2"."id" <> :"someId_3_2" AND
...
WHERE
	EXISTS(
		...
		FROM
			...
			"NewEntities" "t_3"
		WHERE
			"t_3"."id" = "c_4"."id" AND "t_3"."id" <> :"someId_3_3" AND
