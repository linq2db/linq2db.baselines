...
SET     @from_1 = TO_TIMESTAMP('2020-10-20 23:18:27.726496', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-10-21 23:18:27.726496', 'YYYY-MM-DD HH24:MI:SS.FF6')
