...
SET     @from_1 = TO_TIMESTAMP('2020-10-23 15:41:12.849069', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-10-24 15:41:12.849070', 'YYYY-MM-DD HH24:MI:SS.FF6')
