...
SET     @from_1 = TO_TIMESTAMP('2020-11-12 00:06:24.558847', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-13 00:06:24.558847', 'YYYY-MM-DD HH24:MI:SS.FF6')
