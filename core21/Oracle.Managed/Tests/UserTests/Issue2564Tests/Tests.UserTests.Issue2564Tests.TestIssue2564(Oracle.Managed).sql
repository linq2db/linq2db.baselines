...
SET     @from_1 = TO_TIMESTAMP('2020-10-23 16:32:42.400402', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-10-24 16:32:42.400402', 'YYYY-MM-DD HH24:MI:SS.FF6')
