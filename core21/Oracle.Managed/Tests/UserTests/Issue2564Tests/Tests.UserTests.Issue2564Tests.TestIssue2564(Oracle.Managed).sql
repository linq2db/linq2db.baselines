...
SET     @from_1 = TO_TIMESTAMP('2020-11-12 02:55:49.090931', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-13 02:55:49.090932', 'YYYY-MM-DD HH24:MI:SS.FF6')
