...
SET     @from_1 = TO_TIMESTAMP('2020-10-21 06:22:00.870305', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-10-22 06:22:00.870306', 'YYYY-MM-DD HH24:MI:SS.FF6')
