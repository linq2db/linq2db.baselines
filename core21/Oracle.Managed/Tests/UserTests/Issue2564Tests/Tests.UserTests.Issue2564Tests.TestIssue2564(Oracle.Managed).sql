...
SET     @from_1 = TO_TIMESTAMP('2020-11-13 16:47:01.629933', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-14 16:47:01.629934', 'YYYY-MM-DD HH24:MI:SS.FF6')
