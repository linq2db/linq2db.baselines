...
SET     @from_1 = TO_TIMESTAMP('2020-11-13 17:33:29.912746', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-14 17:33:29.912747', 'YYYY-MM-DD HH24:MI:SS.FF6')
