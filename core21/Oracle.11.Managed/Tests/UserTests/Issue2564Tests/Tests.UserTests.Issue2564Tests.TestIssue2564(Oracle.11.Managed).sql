...
SET     @from_1 = TO_TIMESTAMP('2020-11-11 23:57:38.272498', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-12 23:57:38.272498', 'YYYY-MM-DD HH24:MI:SS.FF6')
