...
SET     @from_1 = TO_TIMESTAMP('2020-11-13 21:53:41.325612', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-14 21:53:41.325613', 'YYYY-MM-DD HH24:MI:SS.FF6')
