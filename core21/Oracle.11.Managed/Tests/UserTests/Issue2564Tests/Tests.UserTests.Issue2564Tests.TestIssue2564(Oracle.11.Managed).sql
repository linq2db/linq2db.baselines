...
SET     @from_1 = TO_TIMESTAMP('2020-11-07 18:31:36.654629', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-08 18:31:36.654630', 'YYYY-MM-DD HH24:MI:SS.FF6')
