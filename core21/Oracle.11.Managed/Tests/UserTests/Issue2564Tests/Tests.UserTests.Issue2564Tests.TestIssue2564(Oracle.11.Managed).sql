...
SET     @from_1 = TO_TIMESTAMP('2020-11-13 19:01:41.162579', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-14 19:01:41.162580', 'YYYY-MM-DD HH24:MI:SS.FF6')
