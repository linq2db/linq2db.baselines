...
SET     @from_1 = TO_TIMESTAMP('2020-11-12 01:52:54.638197', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-13 01:52:54.638197', 'YYYY-MM-DD HH24:MI:SS.FF6')
