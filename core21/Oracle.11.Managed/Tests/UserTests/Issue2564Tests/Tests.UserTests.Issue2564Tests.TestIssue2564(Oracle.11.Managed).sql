...
SET     @from_1 = TO_TIMESTAMP('2020-11-12 18:50:08.789593', 'YYYY-MM-DD HH24:MI:SS.FF6')
DECLARE @to_1 TimeStamp -- DateTime
SET     @to_1 = TO_TIMESTAMP('2020-11-13 18:50:08.789594', 'YYYY-MM-DD HH24:MI:SS.FF6')
