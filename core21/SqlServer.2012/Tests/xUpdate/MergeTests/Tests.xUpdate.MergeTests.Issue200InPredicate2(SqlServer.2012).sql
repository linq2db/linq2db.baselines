...
ON (([Source].[datetime2DataType] <> @DateTime OR [Source].[datetime2DataType] IS NULL) AND ([Source].[datetimeoffsetDataType] <> @DateTimeOffset OR [Source].[datetimeoffsetDataType] IS NULL))
