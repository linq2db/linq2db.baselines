...
', 1.17549996E-38, CAST('2098-10-12 21:14:15.997' AS timestamp), X'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', 99999999.9999999999, CAST('3210-11-23' AS timestamp), CAST('' AS VARCHAR(1)), 2147483647 FROM rdb$database) "Source"
(
	"Id",
	"FieldInt32",
	"FieldInt64",
...
USING (	SELECT 3, -123, 987, NULL, CAST('<>?/.,;''zZ":' AS VARCHAR(12)), CAST('`~!@#$%^&*()_+{}|[]\' AS VARCHAR(20)), '', '', -1.17549996E-38, CAST('2098-10-12 21:14:15.907' AS timestamp), X'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', -0.123, CAST('3210-11-23' AS timestamp), NULL, -2147483647 FROM rdb$database
	UNION ALL
...
	' AS VARCHAR(9)), CAST(_utf8 x'D099D0A6D0A3D09AD0A9D18BD0B2D0B0D0BFD180D0BC0D0A71' AS VARCHAR(25)), '1', ' ', 3.40282002E+38, CAST('2001-10-12 21:14:15.167' AS timestamp), X'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', -99999999.9999999999, CAST('2123-11-23' AS timestamp), CAST(_utf8 x'00' AS VARCHAR(1)), 0 FROM rdb$database
	UNION ALL
	SELECT 5, -123, 987, NULL, CAST('<>?/.,;''zZ":' AS VARCHAR(12)), CAST('`~!@#$%^&*()_+{}|[]\' AS VARCHAR(20)), ' ', ' ', -1.17549996E-38, CAST('2098-10-12 21:14:15.913' AS timestamp), X'FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', -0.123, CAST('3210-11-23' AS timestamp), NULL, -2147483647 FROM rdb$database
	UNION ALL
