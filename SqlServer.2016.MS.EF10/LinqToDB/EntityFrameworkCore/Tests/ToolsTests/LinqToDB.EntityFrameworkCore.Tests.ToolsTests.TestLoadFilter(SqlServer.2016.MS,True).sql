Parameters:
@ef_filter__p5='?' (DbType = Boolean), @ef_filter__p1='?' (DbType = Boolean)
...
LEFT JOIN (
    ...
    INNER JOIN (
        ...
        FROM [Orders] AS [o0]
        WHERE @ef_filter__p5 = CAST(1 AS bit) OR [o0].[IsDeleted] = CAST(0 AS bit) OR [o0].[IsDeleted] = CAST(0 AS bit)
    ...
    LEFT JOIN (
        SELECT [s].[SupplierID]
        FROM [Suppliers] AS [s]
        WHERE @ef_filter__p5 = CAST(1 AS bit) OR [s].[IsDeleted] = CAST(0 AS bit) OR [s].[IsDeleted] = CAST(0 AS bit)
    ...
    WHERE @ef_filter__p5 = CAST(1 AS bit) OR [o].[IsDeleted] = CAST(0 AS bit) OR [o].[IsDeleted] = CAST(0 AS bit)
