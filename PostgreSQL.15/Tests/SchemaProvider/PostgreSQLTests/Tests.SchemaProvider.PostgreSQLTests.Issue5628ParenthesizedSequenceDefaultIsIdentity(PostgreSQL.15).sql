...
-- PostgreSQL.15 PostgreSQL12
CREATE TABLE issue5628_parenthesized_default_125 (
...
FROM pg_attrdef
WHERE adrelid = 'issue5628_parenthesized_default_125'::regclass
AND adnum = 1
...
RollbackTransaction
-- PostgreSQL.15 PostgreSQL12
DROP TABLE IF EXISTS issue5628_parenthesized_default_125
