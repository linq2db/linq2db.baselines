...
SELECT
	toDate32(concat('2010-01-', leftPadUTF8(toString(t.TransactionId), toUInt32(toInt32(2)), '0')))
FROM
	Transactions t
WHERE
	DAY(toDate32(concat('2010-01-', leftPadUTF8(toString(t.TransactionId), toUInt32(toInt32(2)), '0')))) > toInt32(0)
