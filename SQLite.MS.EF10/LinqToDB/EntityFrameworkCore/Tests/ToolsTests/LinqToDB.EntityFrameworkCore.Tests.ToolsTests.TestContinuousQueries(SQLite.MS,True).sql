...
LEFT JOIN (
    ...
    LEFT JOIN (
        ...
        WHERE @ef_filter__p3 OR NOT ("o1"."IsDeleted") OR NOT ("o1"."IsDeleted")
    ) AS "o2" ON "p0"."ProductID" = "o2"."ProductID"
    WHERE @ef_filter__p3 OR NOT ("o0"."IsDeleted") OR NOT ("o0"."IsDeleted")
...
FROM
	(
		...
		WHERE
			NOT ([e].[IsDeleted] OR [a_Product].[IsDeleted] OR [d].[IsDeleted])
	) [m_1]
