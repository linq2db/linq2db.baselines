...
SELECT ID FROM ALLTYPES WHERE @p IS NULL AND decfloatDataType IS NULL OR @p IS NOT NULL AND decfloatDataType = @p ORDER BY ID
...
SELECT ID FROM ALLTYPES WHERE decfloatDataType = @p ORDER BY ID
...
SELECT ID FROM ALLTYPES WHERE @p IS NULL AND clobDataType IS NULL OR @p IS NOT NULL AND clobDataType = @p ORDER BY ID
...
SELECT ID FROM ALLTYPES WHERE clobDataType = @p ORDER BY ID
...
SELECT ID FROM ALLTYPES WHERE @p IS NULL AND dbclobDataType IS NULL OR @p IS NOT NULL AND dbclobDataType = @p ORDER BY ID
...
SELECT ID FROM ALLTYPES WHERE dbclobDataType = @p ORDER BY ID
...
SELECT ID FROM ALLTYPES WHERE @p IS NULL AND graphicDataType IS NULL OR @p IS NOT NULL AND graphicDataType = @p ORDER BY ID
...
SELECT ID FROM ALLTYPES WHERE graphicDataType = @p ORDER BY ID
