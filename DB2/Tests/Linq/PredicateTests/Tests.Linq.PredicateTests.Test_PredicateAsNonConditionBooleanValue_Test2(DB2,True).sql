...
FROM
	(
		SELECT
			CAST("g_1"."Value1" = "g_1"."Value2" AS smallint) as "Key_1"
		FROM
			"BooleanTable" "g_1"
	) "g_2"
GROUP BY
...
FROM
	(
		SELECT
			CAST("g_1"."Value1" <> "g_1"."Value4" OR "g_1"."Value4" IS NULL AS smallint) as "Key_1"
		FROM
			"BooleanTable" "g_1"
	) "g_2"
GROUP BY
...
FROM
	(
		SELECT
			CAST("g_1"."Value5" <> "g_1"."Value2" OR "g_1"."Value5" IS NULL AS smallint) as "Key_1"
		FROM
			"BooleanTable" "g_1"
	) "g_2"
GROUP BY
