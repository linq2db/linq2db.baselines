...
SET     @Id = 1
DECLARE @IntClassRequired Integer(4) -- Int32
SET     @IntClassRequired = 0
DECLARE @IntClassNullable Integer -- Int32
SET     @IntClassNullable = NULL
DECLARE @IntClassRequiredWithNull Integer(4) -- Int32
SET     @IntClassRequiredWithNull = -1
DECLARE @IntClassNullableWithNull Integer(4) -- Int32
...
DECLARE @IntStructRequired Integer(4) -- Int32
SET     @IntStructRequired = 0
DECLARE @IntStructNullable Integer -- Int32
SET     @IntStructNullable = NULL
DECLARE @IntStructRequiredWithNull Integer(4) -- Int32
SET     @IntStructRequiredWithNull = -1
DECLARE @IntStructNullableWithNull Integer(4) -- Int32
...
DECLARE @IntClassNullable Integer(4) -- Int32
...
DECLARE @IntStructNullable Integer(4) -- Int32
