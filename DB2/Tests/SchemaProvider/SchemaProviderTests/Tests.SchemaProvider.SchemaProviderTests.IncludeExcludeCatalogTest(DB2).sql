...
SELECT * FROM (
	...
	WHERE p.PROCSCHEMA = 'DB2INST1'
	 AND p.PROCSCHEMA NOT IN ('SYSPROC', 'SYSIBMADM', 'SQLJ', 'SYSIBM')
	UNION ALL
	SELECT
		f.SPECIFICNAME,
		f.FUNCSCHEMA,
	...
	WHERE f.FUNCSCHEMA = 'DB2INST1'
	 AND f.FUNCSCHEMA NOT IN ('SYSPROC', 'SYSIBMADM', 'SQLJ', 'SYSIBM'))
