...
USING (VALUES
	(1,CAST(NULL AS Int),CAST(NULL AS BigInt),CAST(NULL AS smallint),CAST(NULL AS NVarChar(255)),CAST(NULL AS NVarChar(255)),CAST(NULL AS NChar(1)),CAST(NULL AS NChar(1)),CAST(NULL AS Real),CAST(NULL AS Float),CAST(NULL AS timestamp),CAST(NULL AS VARBINARY(32672)),CAST(NULL AS char(16) for bit data),CAST(NULL AS Decimal),CAST(NULL AS timestamp),CAST(NULL AS Time),CAST(NULL AS NVarChar(5)),CAST(NULL AS Int)),
