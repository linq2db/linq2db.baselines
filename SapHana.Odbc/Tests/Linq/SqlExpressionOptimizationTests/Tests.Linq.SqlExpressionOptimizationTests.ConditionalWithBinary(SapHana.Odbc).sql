...
SET     @BoolValue = 1
DECLARE @BoolValueNullable  -- Byte
...
WHERE
	CASE
		WHEN "x_with_not"."BoolValue" = 1 THEN 1
		ELSE 0
	END = 0
...
WHERE
	CASE
		WHEN "swap_with_not"."BoolValue" = 1 THEN 1
		ELSE 0
	END = 0
...
WHERE
	CASE
		WHEN "swap"."BoolValue" = 1 THEN NULL
		ELSE 1
	END = 1
