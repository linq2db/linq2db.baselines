...
FROM
	(
		...
		WHERE
			("nomin_2"."DeliveryCounterParty" LIKE ? ESCAPE '~' OR "trade_2"."CounterParty" LIKE ? ESCAPE '~' OR "al_group_1"."AlertCode" LIKE ? ESCAPE '~')
		GROUP BY
			"al_group_1"."AlertKey",
			"al_group_1"."AlertCode",
			"al_group_1"."CreationDate"
		...
		LEFT JOIN (
			...
			WHERE
				("nomin_4"."DeliveryCounterParty" LIKE ? ESCAPE '~' OR "trade_4"."CounterParty" LIKE ? ESCAPE '~' OR "t1"."AlertCode" LIKE ? ESCAPE '~')
