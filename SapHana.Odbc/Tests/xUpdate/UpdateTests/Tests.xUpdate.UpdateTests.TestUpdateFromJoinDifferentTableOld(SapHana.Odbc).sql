...
SET
	...
	"col2" = (
		...
		FROM
			"gt_s_one" "x_2"
				LEFT JOIN "access_mode" "y1_2" ON Upper(REPLACE("x_2"."col3", 'auth.', '')) = Upper("y1_2"."code") OR REPLACE("x_2"."col3", 'auth.', '') IS NULL AND "y1_2"."code" IS NULL
		WHERE
	...
	"col3" = (
		...
		FROM
			"gt_s_one" "x_3"
				LEFT JOIN "access_mode" "y1_3" ON Upper(REPLACE("x_3"."col3", 'auth.', '')) = Upper("y1_3"."code") OR REPLACE("x_3"."col3", 'auth.', '') IS NULL AND "y1_3"."code" IS NULL
		WHERE
	...
	"col4" = (
		...
		FROM
			"gt_s_one" "x_4"
				LEFT JOIN "access_mode" "y1_4" ON Upper(REPLACE("x_4"."col3", 'auth.', '')) = Upper("y1_4"."code") OR REPLACE("x_4"."col3", 'auth.', '') IS NULL AND "y1_4"."code" IS NULL
		WHERE
	...
	"col5" = (
		...
		FROM
			"gt_s_one" "x_5"
				LEFT JOIN "access_mode" "y1_5" ON Upper(REPLACE("x_5"."col3", 'auth.', '')) = Upper("y1_5"."code") OR REPLACE("x_5"."col3", 'auth.', '') IS NULL AND "y1_5"."code" IS NULL
		WHERE
	...
	"col6" = (
		...
		FROM
			"gt_s_one" "x_6"
				LEFT JOIN "access_mode" "y1_6" ON Upper(REPLACE("x_6"."col3", 'auth.', '')) = Upper("y1_6"."code") OR REPLACE("x_6"."col3", 'auth.', '') IS NULL AND "y1_6"."code" IS NULL
		WHERE
