...
SELECT
	...
	t1."ParcelID",
	t1."Id_1",
	t1."DeliveryDealNumber",
	t1."DeliveryParcelGroup",
	t1."DeliveryParcelID",
	t1."ReceiptDealNumber",
	t1."ReceiptParcelGroup",
	t1."ReceiptParcelID",
	t1."Id_2",
	t1."DeliveryDealNumber_1",
	t1."DeliveryParcelGroup_1",
	t1."DeliveryParcelID_1",
	t1."ReceiptDealNumber_1",
	t1."ReceiptParcelGroup_1",
	t1."ReceiptParcelID_1"
FROM
	(
		SELECT
			after_1."Id",
