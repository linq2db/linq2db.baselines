...
SET     @userId = 'b18b1d21-37b0-4bb2-b8c6-d7c78773c1ec'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 17, 10, 55, 3093320, 7)
...
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 17, 10, 55, 3093320, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 17, 10, 55, 3093320, 7)
...
-- SqlServer.2012.MS SqlServer.2012
DECLARE @userId UniqueIdentifier -- Guid
SET     @userId = '0c00a8fc-f30e-4f01-ab05-a083de69537d'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 17, 10, 55, 3724870, 7)
...
SET     @userId = '0c00a8fc-f30e-4f01-ab05-a083de69537d'
DECLARE @now_1 DateTime2
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 17, 10, 55, 3724870, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 17, 10, 55, 3724870, 7)
