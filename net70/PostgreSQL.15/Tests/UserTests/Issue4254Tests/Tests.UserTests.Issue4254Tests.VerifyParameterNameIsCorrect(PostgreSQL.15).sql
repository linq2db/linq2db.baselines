...
SET     @userId = 'aa1f7db5-fd0a-4adc-a549-c26be189c168'::uuid
DECLARE @now Timestamp -- DateTime2
SET     @now = '2023-08-30 20:54:31.554'::timestamp
...
SET     @now_1 = '2023-08-30 20:54:31.554'::timestamp
DECLARE @now_2 Timestamp -- DateTime2
SET     @now_2 = '2023-08-30 20:54:31.554'::timestamp
...
-- PostgreSQL.15 PostgreSQL
DECLARE @userId Uuid -- Guid
SET     @userId = '32b54f07-1a79-4d2a-be99-345c52976807'::uuid
DECLARE @now Timestamp -- DateTime2
SET     @now = '2023-08-30 20:54:31.630'::timestamp
...
SET     @userId = '32b54f07-1a79-4d2a-be99-345c52976807'::uuid
DECLARE @now_1 Timestamp -- DateTime2
SET     @now_1 = '2023-08-30 20:54:31.630'::timestamp
DECLARE @now_2 Timestamp -- DateTime2
SET     @now_2 = '2023-08-30 20:54:31.630'::timestamp
