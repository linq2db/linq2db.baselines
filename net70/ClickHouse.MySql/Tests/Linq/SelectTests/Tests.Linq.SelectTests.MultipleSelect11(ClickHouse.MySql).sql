...
WHERE
	a_Child_19.ChildID = toInt32(20) AND
	a_Child_18.ChildID = toInt32(19) AND
	a_Child_17.ChildID = toInt32(18) AND
	a_Child_16.ChildID = toInt32(17) AND
	a_Child_15.ChildID = toInt32(16) AND
	a_Child_14.ChildID = toInt32(15) AND
	a_Child_13.ChildID = toInt32(14) AND
	a_Child_12.ChildID = toInt32(13) AND
	a_Child_11.ChildID = toInt32(12) AND
	a_Child_10.ChildID = toInt32(11) AND
	a_Child_9.ChildID = toInt32(10) AND
	a_Child_8.ChildID = toInt32(9) AND
	a_Child_7.ChildID = toInt32(8) AND
	a_Child_6.ChildID = toInt32(7) AND
	a_Child_5.ChildID = toInt32(6) AND
	a_Child_4.ChildID = toInt32(5) AND
	a_Child_3.ChildID = toInt32(4) AND
	a_Child_2.ChildID = toInt32(3) AND
	a_Child_1.ChildID = toInt32(2) AND
	a_Child.ChildID = toInt32(1)
ORDER BY
	a_Child.ChildID,
	a_Child_1.ChildID,
	a_Child_2.ChildID,
