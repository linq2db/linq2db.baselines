...
SET     @p_1 = DATETIME2FROMPARTS(2023, 2, 28, 3, 40, 56, 7641677, 7)
DECLARE @p_2 DateTime2
SET     @p_2 = DATETIME2FROMPARTS(2023, 2, 28, 3, 40, 57, 2201105, 7)
DECLARE @p_3 DateTime2
SET     @p_3 = DATETIME2FROMPARTS(2023, 2, 28, 3, 40, 56, 7641677, 7)
DECLARE @p_4 DateTime2
SET     @p_4 = DATETIME2FROMPARTS(2023, 2, 28, 3, 40, 57, 2201105, 7)
