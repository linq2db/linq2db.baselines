...
DECLARE @FieldDateTime DateTime2
SET     @FieldDateTime = CAST('2000-11-12T21:14:15.1670000' AS DATETIME2)
DECLARE @FieldDateTime2 DateTimeOffset
SET     @FieldDateTime2 = CAST('2000-11-22T13:14:15.1244567+00:15' AS DATETIMEOFFSET)
DECLARE @FieldBinary VarBinary(8000) -- Binary
SET     @FieldBinary = 0x
DECLARE @FieldGuid UniqueIdentifier -- Guid
...
DECLARE @FieldDate DateTime2
SET     @FieldDate = CAST('2000-11-23T00:00:00.0000000' AS DATETIME2)
DECLARE @FieldTime Time
SET     @FieldTime = CAST('09:44:34.6534321' AS TIME)
DECLARE @FieldEnumString NVarChar(5) -- String
...
SET     @FieldDouble = 1.7976931348623157E+308
DECLARE @FieldDateTime DateTime2
SET     @FieldDateTime = CAST('2001-10-12T21:14:15.1670000' AS DATETIME2)
DECLARE @FieldDateTime2 DateTimeOffset
SET     @FieldDateTime2 = CAST('2001-11-22T13:14:15.1234567-00:15' AS DATETIMEOFFSET)
DECLARE @FieldBinary VarBinary(8000) -- Binary
...
DECLARE @FieldDate DateTime2
SET     @FieldDate = CAST('2123-11-23T00:00:00.0000000' AS DATETIME2)
DECLARE @FieldTime Time
SET     @FieldTime = CAST('00:44:34.6414321' AS TIME)
DECLARE @FieldEnumString NVarChar(5) -- String
...
DECLARE @FieldDateTime DateTime2
SET     @FieldDateTime = CAST('2098-10-12T21:14:15.9970000' AS DATETIME2)
DECLARE @FieldDateTime2 DateTimeOffset
SET     @FieldDateTime2 = CAST('2001-11-22T13:14:16.1224567+01:39' AS DATETIMEOFFSET)
DECLARE @FieldBinary VarBinary(8000) -- Binary
...
SET     @FieldDecimal = 99999999.9999999999
DECLARE @FieldDate DateTime2
SET     @FieldDate = CAST('2110-11-23T00:00:00.0000000' AS DATETIME2)
DECLARE @FieldTime Time
SET     @FieldTime = CAST('00:00:00.0000000' AS TIME)
DECLARE @FieldEnumString NVarChar(5) -- String
...
SET     @FieldDouble = 2.2250738585072014E-308
DECLARE @FieldDateTime DateTime2
SET     @FieldDateTime = CAST('2098-10-12T21:14:15.9070000' AS DATETIME2)
DECLARE @FieldDateTime2 DateTimeOffset
SET     @FieldDateTime2 = CAST('2001-11-22T13:14:14.1233457-01:39' AS DATETIMEOFFSET)
DECLARE @FieldBinary VarBinary(8000) -- Binary
SET     @FieldBinary = 0xFFC864321400
DECLARE @FieldGuid UniqueIdentifier -- Guid
SET     @FieldGuid = 'ffffffff-ffff-ffff-ffff-ffffffffffff'
...
DECLARE @FieldDate DateTime2
SET     @FieldDate = CAST('2111-11-23T00:00:00.0000000' AS DATETIME2)
DECLARE @FieldTime Time
SET     @FieldTime = CAST('23:59:59.9999999' AS TIME)
DECLARE @FieldEnumString NVarChar(5) -- String
SET     @FieldEnumString = NULL
DECLARE @FieldEnumNumber Int -- Int32
SET     @FieldEnumNumber = -2147483647
...
SET     @FieldDateTime = CAST('2001-10-12T21:14:15.1670000' AS DATETIME2)
DECLARE @FieldDateTime2 DateTimeOffset
SET     @FieldDateTime2 = CAST('2001-11-22T13:14:15.3210000-00:15' AS DATETIMEOFFSET)
DECLARE @FieldBinary VarBinary(8000) -- Binary
SET     @FieldBinary = 0x000102030004
DECLARE @FieldGuid UniqueIdentifier -- Guid
SET     @FieldGuid = 'ffffffff-ffff-ffff-ffff-ffffffffffff'
...
SET     @FieldDate = CAST('2123-11-23T00:00:00.0000000' AS DATETIME2)
DECLARE @FieldTime Time
SET     @FieldTime = CAST('14:44:33.2340000' AS TIME)
DECLARE @FieldEnumString NVarChar(5) -- String
SET     @FieldEnumString = char(0)
DECLARE @FieldEnumNumber Int -- Int32
SET     @FieldEnumNumber = 0
...
SET     @FieldDouble = 2.2250738585072014E-308
DECLARE @FieldDateTime DateTime2
SET     @FieldDateTime = CAST('2098-10-12T21:14:15.9130000' AS DATETIME2)
DECLARE @FieldDateTime2 DateTimeOffset
SET     @FieldDateTime2 = CAST('2001-11-22T13:14:15.0000000-01:39' AS DATETIMEOFFSET)
DECLARE @FieldBinary VarBinary(8000) -- Binary
SET     @FieldBinary = 0xFFC864321400
DECLARE @FieldGuid UniqueIdentifier -- Guid
SET     @FieldGuid = 'ffffffff-ffff-ffff-ffff-ffffffffffff'
...
SET     @FieldDecimal = -0.123
DECLARE @FieldDate DateTime2
SET     @FieldDate = CAST('2010-11-23T00:00:00.0000000' AS DATETIME2)
DECLARE @FieldTime Time
SET     @FieldTime = CAST('23:59:59.9999999' AS TIME)
DECLARE @FieldEnumString NVarChar(5) -- String
SET     @FieldEnumString = NULL
...
SET     @FieldDateTime = CAST('2001-10-12T21:14:15.1670000' AS DATETIME2)
DECLARE @FieldDateTime2 DateTimeOffset
SET     @FieldDateTime2 = CAST('2001-11-22T13:14:15.9990000-00:15' AS DATETIMEOFFSET)
DECLARE @FieldBinary VarBinary(8000) -- Binary
SET     @FieldBinary = 0x000102030004
DECLARE @FieldGuid UniqueIdentifier -- Guid
SET     @FieldGuid = 'ffffffff-ffff-ffff-ffff-ffffffffffff'
...
SET     @FieldDate = CAST('2123-11-23T00:00:00.0000000' AS DATETIME2)
DECLARE @FieldTime Time
SET     @FieldTime = CAST('22:44:33.0000000' AS TIME)
DECLARE @FieldEnumString NVarChar(5) -- String
SET     @FieldEnumString = char(0)
DECLARE @FieldEnumNumber Int -- Int32
SET     @FieldEnumNumber = 0
