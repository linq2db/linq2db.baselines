...
VALUES
(DATETIME2FROMPARTS(2023, 2, 6, 16, 59, 23, 1825197, 7),CAST(20000000000 AS BIGINT),TIMEFROMPARTS(0, 33, 20, 0, 7),TIMEFROMPARTS(0, 33, 20, 0, 7),DATETIME2FROMPARTS(2023, 2, 6, 0, 0, 0, 0, 7))
