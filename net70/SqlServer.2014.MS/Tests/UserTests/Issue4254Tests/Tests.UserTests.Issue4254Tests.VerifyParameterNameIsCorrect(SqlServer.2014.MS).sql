...
SET     @userId = 'd961949b-fca1-4bbc-97e8-397d9530c7b5'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 17, 14, 15, 6646099, 7)
...
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 17, 14, 15, 6646099, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 17, 14, 15, 6646099, 7)
...
-- SqlServer.2014.MS SqlServer.2014
DECLARE @userId UniqueIdentifier -- Guid
SET     @userId = 'e99c954c-0df8-4316-aecf-bacdf960d357'
DECLARE @now DateTime2
SET     @now = DATETIME2FROMPARTS(2023, 8, 30, 17, 14, 15, 7189709, 7)
...
SET     @userId = 'e99c954c-0df8-4316-aecf-bacdf960d357'
DECLARE @now_1 DateTime2
SET     @now_1 = DATETIME2FROMPARTS(2023, 8, 30, 17, 14, 15, 7189709, 7)
DECLARE @now_2 DateTime2
SET     @now_2 = DATETIME2FROMPARTS(2023, 8, 30, 17, 14, 15, 7189709, 7)
