...
SET     @p_1 = DATETIME2FROMPARTS(2023, 3, 1, 18, 37, 36, 3989672, 7)
DECLARE @p_2 DateTime2
SET     @p_2 = DATETIME2FROMPARTS(2023, 3, 1, 18, 37, 36, 8550471, 7)
DECLARE @p_3 DateTime2
SET     @p_3 = DATETIME2FROMPARTS(2023, 3, 1, 18, 37, 36, 3989672, 7)
DECLARE @p_4 DateTime2
SET     @p_4 = DATETIME2FROMPARTS(2023, 3, 1, 18, 37, 36, 8550471, 7)
