...
VALUES
(DATETIME2FROMPARTS(2023, 1, 31, 21, 42, 33, 3118296, 7),CAST(20000000000 AS BIGINT),TIMEFROMPARTS(0, 33, 20, 0, 7),TIMEFROMPARTS(0, 33, 20, 0, 7),DATETIME2FROMPARTS(2023, 1, 31, 0, 0, 0, 0, 7))
