...
FROM
	"Ints" i
WHERE
	(TO_DATE('2020-10-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2020-10-05 00:00:00', 'YYYY-MM-DD HH24:MI:SS')) OVERLAPS (TO_DATE('2020-10-03 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2020-11-09 00:00:00', 'YYYY-MM-DD HH24:MI:SS'))
...
FROM
	"Ints" i
WHERE
	(TO_DATE('2020-10-03 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), :p) OVERLAPS (TO_DATE('2020-10-05 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), :p_1)
...
FROM
	"Ints" i
WHERE
	(TO_DATE('2020-10-03 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), :p) OVERLAPS (TO_DATE('2020-10-05 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), NULL)
