...
INSERT INTO l2dbnh_courses (title, deptid, courseno) VALUES (@p0, @p1, @p2);@p0 = 'Algorithms' [Type: String (10:0:0)], @p1 = 10 [Type: Int32 (0:0:0)], @p2 = 101 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_courses (title, deptid, courseno) VALUES (@p0, @p1, @p2);@p0 = 'Databases' [Type: String (9:0:0)], @p1 = 20 [Type: Int32 (0:0:0)], @p2 = 201 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_students (name, campusid, roll) VALUES (@p0, @p1, @p2);@p0 = 'Ann' [Type: String (3:0:0)], @p1 = 1 [Type: Int32 (0:0:0)], @p2 = 5 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_students (name, campusid, roll) VALUES (@p0, @p1, @p2);@p0 = 'Bob' [Type: String (3:0:0)], @p1 = 2 [Type: Int32 (0:0:0)], @p2 = 6 [Type: Int32 (0:0:0)]

INSERT INTO l2dbnh_students (name, campusid, roll) VALUES (@p0, @p1, @p2);@p0 = 'Cy' [Type: String (2:0:0)], @p1 = 3 [Type: Int32 (0:0:0)], @p2 = 7 [Type: Int32 (0:0:0)]
