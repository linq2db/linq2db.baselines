...
WHERE
	...
	[x].[NotificationDateTime] < DATETIME2FROMPARTS(2025, 8, 31, 18, 47, 26, 7024136, 7) AND
	CAST([x].[StartDateTime] AS Date) < CAST(DATETIME2FROMPARTS(2025, 8, 31, 18, 47, 26, 7025942, 7) AS Date)
