...
CREATE SEQUENCE issue5628_code_seq_118

-- PostgreSQL.14 PostgreSQL.13 PostgreSQL12
CREATE SEQUENCE issue5628_item_id_seq_118

-- PostgreSQL.14 PostgreSQL.13 PostgreSQL12
CREATE TABLE issue5628_sample_messages_118 (
	code character varying(255) DEFAULT ('PREFIX_'::text || nextval('issue5628_code_seq_118'::regclass)) NOT NULL,
	...
	CONSTRAINT issue5628_sample_messages_118_pkey PRIMARY KEY (item_id, item_type),
	CONSTRAINT issue5628_sample_messages_118_code_key UNIQUE (code)
)
...
RollbackTransaction
-- PostgreSQL.14 PostgreSQL.13 PostgreSQL12
DROP TABLE IF EXISTS issue5628_sample_messages_118

-- PostgreSQL.14 PostgreSQL.13 PostgreSQL12
DROP SEQUENCE IF EXISTS issue5628_code_seq_118
